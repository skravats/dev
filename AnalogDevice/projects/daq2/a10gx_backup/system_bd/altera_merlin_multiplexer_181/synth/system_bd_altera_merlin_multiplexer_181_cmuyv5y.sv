...
//   output_name:         system_bd_altera_merlin_multiplexer_181_cmuyv5y
//   NUM_INPUTS:          8
...
module system_bd_altera_merlin_multiplexer_181_cmuyv5y
(
    // ----------------------
    // Sinks
    // ----------------------
    ...
    always @* begin
      ...
      lock[3] = sink3_data[612];
      lock[4] = sink4_data[612];
      lock[5] = sink5_data[612];
      lock[6] = sink6_data[612];
      lock[7] = sink7_data[612];
    end
