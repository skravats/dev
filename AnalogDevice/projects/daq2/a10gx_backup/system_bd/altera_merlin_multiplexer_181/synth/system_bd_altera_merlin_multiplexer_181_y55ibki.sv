...
//   output_name:         system_bd_altera_merlin_multiplexer_181_y55ibki
//   NUM_INPUTS:          45
...
module system_bd_altera_merlin_multiplexer_181_y55ibki
(
    // ----------------------
    // Sinks
    // ----------------------
    ...
    input                       sink42_valid,
    input [130-1   : 0]  sink42_data,
    input [45-1: 0]  sink42_channel,
    input                       sink42_startofpacket,
    input                       sink42_endofpacket,
    output                      sink42_ready,

    input                       sink43_valid,
    input [130-1   : 0]  sink43_data,
    input [45-1: 0]  sink43_channel,
    input                       sink43_startofpacket,
    input                       sink43_endofpacket,
    output                      sink43_ready,

    input                       sink44_valid,
    input [130-1   : 0]  sink44_data,
    input [45-1: 0]  sink44_channel,
