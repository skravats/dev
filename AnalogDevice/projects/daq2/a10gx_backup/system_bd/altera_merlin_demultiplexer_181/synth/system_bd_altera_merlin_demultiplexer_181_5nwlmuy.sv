...
//   output_name:         system_bd_altera_merlin_demultiplexer_181_5nwlmuy
//   ST_DATA_W:           130
//   ST_CHANNEL_W:        45
//   NUM_OUTPUTS:         45
//   VALID_WIDTH:         1
...
module system_bd_altera_merlin_demultiplexer_181_5nwlmuy
(
    // -------------------
    // Sink
    // -------------------
    ...
    output reg [130-1    : 0] src12_data, // ST_DATA_W=130
    ...
    output reg [130-1    : 0] src13_data, // ST_DATA_W=130
    ...
    output reg [130-1    : 0] src14_data, // ST_DATA_W=130
    ...
    output reg [130-1    : 0] src15_data, // ST_DATA_W=130
    ...
    output reg [130-1    : 0] src16_data, // ST_DATA_W=130
    ...
    output reg [130-1    : 0] src17_data, // ST_DATA_W=130
    ...
    output reg [130-1    : 0] src18_data, // ST_DATA_W=130
    ...
    output reg [130-1    : 0] src19_data, // ST_DATA_W=130
    ...
    output reg [130-1    : 0] src20_data, // ST_DATA_W=130
    ...
    output reg [130-1    : 0] src21_data, // ST_DATA_W=130
    ...
    output reg [130-1    : 0] src22_data, // ST_DATA_W=130
    ...
    output reg [130-1    : 0] src23_data, // ST_DATA_W=130
    ...
    output reg [130-1    : 0] src24_data, // ST_DATA_W=130
    ...
    output reg [130-1    : 0] src25_data, // ST_DATA_W=130
    ...
    output reg [130-1    : 0] src26_data, // ST_DATA_W=130
    ...
    output reg [130-1    : 0] src27_data, // ST_DATA_W=130
    ...
    output reg [130-1    : 0] src28_data, // ST_DATA_W=130
    ...
    output reg [130-1    : 0] src29_data, // ST_DATA_W=130
    ...
    output reg [130-1    : 0] src30_data, // ST_DATA_W=130
    ...
    output reg [130-1    : 0] src31_data, // ST_DATA_W=130
    ...
    output reg [130-1    : 0] src32_data, // ST_DATA_W=130
    ...
    output reg [130-1    : 0] src33_data, // ST_DATA_W=130
    ...
    output reg [130-1    : 0] src34_data, // ST_DATA_W=130
    ...
    output reg [130-1    : 0] src35_data, // ST_DATA_W=130
    ...
    output reg [130-1    : 0] src36_data, // ST_DATA_W=130
    ...
    output reg [130-1    : 0] src37_data, // ST_DATA_W=130
    ...
    output reg [130-1    : 0] src38_data, // ST_DATA_W=130
    ...
    output reg [130-1    : 0] src39_data, // ST_DATA_W=130
    ...
    output reg [130-1    : 0] src40_data, // ST_DATA_W=130
    ...
    output reg [130-1    : 0] src41_data, // ST_DATA_W=130
    ...
    output reg [130-1    : 0] src42_data, // ST_DATA_W=130
    output reg [45-1 : 0] src42_channel, // ST_CHANNEL_W=45
    output reg                      src42_startofpacket,
    output reg                      src42_endofpacket,
    input                           src42_ready,

    output reg                      src43_valid,
    output reg [130-1    : 0] src43_data, // ST_DATA_W=130
    output reg [45-1 : 0] src43_channel, // ST_CHANNEL_W=45
    output reg                      src43_startofpacket,
    output reg                      src43_endofpacket,
    input                           src43_ready,

    output reg                      src44_valid,
    output reg [130-1    : 0] src44_data, // ST_DATA_W=130
    output reg [45-1 : 0] src44_channel, // ST_CHANNEL_W=45
