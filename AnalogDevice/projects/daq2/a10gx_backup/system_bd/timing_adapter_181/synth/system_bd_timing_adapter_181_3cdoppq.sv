...
//   output_name:        system_bd_timing_adapter_181_3cdoppq
//   in_use_ready:       true
//   out_use_ready:      true
//   in_use_valid:       true
//   out_use_valid:      true
...
module system_bd_timing_adapter_181_3cdoppq
(  
 output reg         in_ready,
 input               in_valid,
 ...
 /*AUTOARG*/);
   ...
   //| FIFO
   // ---------------------------------------------------------------------                           
   system_bd_timing_adapter_181_3cdoppq_fifo system_bd_timing_adapter_181_3cdoppq_fifo 
     ( 
       .clk        (clk),
       .reset_n    (reset_n),
       .in_ready   (),
