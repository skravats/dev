...
module system_bd_altera_arria10_interface_generator_140_nuexhka(
// hps_io
...
assign hps_io_phery_i2c1_SDA = intermediate[36] ? '0 : 'z;
assign hps_io_phery_i2c1_SCL = intermediate[37] ? '0 : 'z;
assign hps_io_gpio_gpio1_io5 = intermediate[39] ? intermediate[38] : 'z;
assign hps_io_gpio_gpio1_io14 = intermediate[41] ? intermediate[40] : 'z;
assign hps_io_gpio_gpio1_io16 = intermediate[43] ? intermediate[42] : 'z;
assign hps_io_gpio_gpio1_io17 = intermediate[45] ? intermediate[44] : 'z;
...
twentynm_hps_peripheral_gpio gpio(
 .GPIO1_PORTA_OE({
   ...
   ,floating[0:0] // 15:15
   ,intermediate[41:41] // 14:14
   ,floating[8:1] // 13:6
   ,intermediate[39:39] // 5:5
   ,floating[13:9] // 4:0
  })
,.GPIO1_PORTA_I({
...
,.GPIO1_PORTA_O({
   ...
   ,intermediate[40:40] // 14:14
   ,floating[36:29] // 13:6
   ,intermediate[38:38] // 5:5
   ,floating[41:37] // 4:0
  })
);
