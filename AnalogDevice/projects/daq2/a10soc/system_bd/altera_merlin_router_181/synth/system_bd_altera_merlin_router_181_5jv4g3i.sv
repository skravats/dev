...
module system_bd_altera_merlin_router_181_5jv4g3i_default_decode
  #(
...
module system_bd_altera_merlin_router_181_5jv4g3i
(
    // -------------------
    // Clock & Reset
    // -------------------
    ...
    system_bd_altera_merlin_router_181_5jv4g3i_default_decode the_default_decode(
    ...
    // ( 0x20000 .. 0x24000 )
    if ( {address[RG:PAD4],{PAD4{1'b0}}} == 19'h20000  && read_transaction  ) begin
            src_channel = 31'b00000000000000000000100;
            src_data[PKT_DEST_ID_H:PKT_DEST_ID_L] = 1;
    end

    // ( 0x24000 .. 0x25000 )
    if ( {address[RG:PAD5],{PAD5{1'b0}}} == 19'h24000  && read_transaction  ) begin
    ...
    // ( 0x2c000 .. 0x2d000 )
    if ( {address[RG:PAD12],{PAD12{1'b0}}} == 19'h2c000  && read_transaction  ) begin
            src_channel = 31'b00000000000000000010000;
            src_data[PKT_DEST_ID_H:PKT_DEST_ID_L] = 16;
    end

    // ( 0x30000 .. 0x40000 )
    if ( {address[RG:PAD13],{PAD13{1'b0}}} == 19'h30000  && read_transaction  ) begin
            src_channel = 31'b00000000000000000100000;
            src_data[PKT_DEST_ID_H:PKT_DEST_ID_L] = 15;
    end

    // ( 0x40000 .. 0x44000 )
    if ( {address[RG:PAD14],{PAD14{1'b0}}} == 19'h40000  && read_transaction  ) begin
            src_channel = 31'b00000000000000000001000;
            src_data[PKT_DEST_ID_H:PKT_DEST_ID_L] = 5;
    end

    // ( 0x44000 .. 0x45000 )
    if ( {address[RG:PAD15],{PAD15{1'b0}}} == 19'h44000  && read_transaction  ) begin
    ...
    // ( 0x4c000 .. 0x4d000 )
    if ( {address[RG:PAD21],{PAD21{1'b0}}} == 19'h4c000  && read_transaction  ) begin
            src_channel = 31'b00000000000000001000000;
            src_data[PKT_DEST_ID_H:PKT_DEST_ID_L] = 18;
    end

    // ( 0x50000 .. 0x60000 )
    if ( {address[RG:PAD22],{PAD22{1'b0}}} == 19'h50000  && read_transaction  ) begin
