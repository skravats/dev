...
set ::GLOBAL_system_bd_altera_emif_arch_nf_181_5knmixi_corename system_bd_altera_emif_arch_nf_181_5knmixi
...
set var(tDS)                                                     0.046860356138706656
set var(tDH)                                                     0.046860356138706656
set var(tIS)                                                     0.062
set var(tIH)                                                     0.086999999999999994
set var(tDQSCK)                                                  0.16500000000000001
set var(tDQSS)                                                   0.27
set var(tWLS)                                                    0.16250000000000001
set var(tWLH)                                                    0.16250000000000001
set var(tDSS)                                                    0.18
set var(tDSH)                                                    0.18
...
set var(PHY_MEM_CLK_FREQ_MHZ)                                    1067.0
set var(PHY_REF_CLK_FREQ_MHZ)                                    266.75
