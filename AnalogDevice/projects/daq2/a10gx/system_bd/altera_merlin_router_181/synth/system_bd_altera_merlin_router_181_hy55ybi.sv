...
module system_bd_altera_merlin_router_181_hy55ybi_default_decode
  #(
  ...
  (output [224 - 219 : 0] default_destination_id,
...
module system_bd_altera_merlin_router_181_hy55ybi
(
    // -------------------
    // Clock & Reset
    // -------------------
    ...
    system_bd_altera_merlin_router_181_hy55ybi_default_decode the_default_decode(
