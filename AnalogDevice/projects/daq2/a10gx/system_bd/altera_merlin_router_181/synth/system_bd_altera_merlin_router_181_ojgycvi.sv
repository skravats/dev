...
module system_bd_altera_merlin_router_181_ojgycvi_default_decode
  #(
  ...
  (output [368 - 363 : 0] default_destination_id,
...
module system_bd_altera_merlin_router_181_ojgycvi
(
    // -------------------
    // Clock & Reset
    // -------------------
    ...
    system_bd_altera_merlin_router_181_ojgycvi_default_decode the_default_decode(
