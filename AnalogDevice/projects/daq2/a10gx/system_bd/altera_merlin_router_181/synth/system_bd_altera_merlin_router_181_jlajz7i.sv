...
module system_bd_altera_merlin_router_181_jlajz7i_default_decode
  #(
...
module system_bd_altera_merlin_router_181_jlajz7i
(
    // -------------------
    // Clock & Reset
    // -------------------
    ...
    localparam PAD1 = log2ceil(64'h10180000 - 64'h10140000); 
    localparam PAD2 = log2ceil(64'h10181000 - 64'h10180800); 
    localparam PAD3 = log2ceil(64'h12000000 - 64'h11000000); 
    // -------------------------------------------------------
    ...
    system_bd_altera_merlin_router_181_jlajz7i_default_decode the_default_decode(
    ...
    if ( {address[RG:PAD1],{PAD1{1'b0}}} == 29'h10140000   ) begin
            src_channel = 45'b0100;
            src_data[PKT_DEST_ID_H:PKT_DEST_ID_L] = 32;
    end

    // ( 0x10180800 .. 0x10181000 )
    if ( {address[RG:PAD2],{PAD2{1'b0}}} == 29'h10180800   ) begin
            src_channel = 45'b0010;
            src_data[PKT_DEST_ID_H:PKT_DEST_ID_L] = 19;
    end

    // ( 0x11000000 .. 0x12000000 )
    if ( {address[RG:PAD3],{PAD3{1'b0}}} == 29'h11000000   ) begin
