...
module system_bd_altera_merlin_router_181_ud7dcxq_default_decode
  #(
  ...
  (output [152 - 147 : 0] default_destination_id,
...
module system_bd_altera_merlin_router_181_ud7dcxq
(
    // -------------------
    // Clock & Reset
    // -------------------
    ...
    system_bd_altera_merlin_router_181_ud7dcxq_default_decode the_default_decode(
