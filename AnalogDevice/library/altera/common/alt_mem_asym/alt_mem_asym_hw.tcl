...
#  add_interface wrclock   conduit end
  add_interface wrclock   clock sink
  
  add_interface wraddress conduit end
  ...
  add_interface rdclock   clock sink
  #add_interface rden      conduit end

  set_interface_property wrclock   EXPORT_OF alt_mem.wrclock
  set_interface_property wraddress EXPORT_OF alt_mem.wraddress
  set_interface_property data      EXPORT_OF alt_mem.data
  set_interface_property mem_o     EXPORT_OF alt_mem.q
  set_interface_property wren      EXPORT_OF alt_mem.wren
  set_interface_property rdaddress EXPORT_OF alt_mem.rdaddress
  set_interface_property rdclock   EXPORT_OF alt_mem.rdclock
  #set_interface_property rden      EXPORT_OF alt_mem.rden
