...
set_location_assignment PIN_AF29  -to hdmi_red[0]
set_location_assignment PIN_AF30  -to hdmi_red[1]
set_location_assignment PIN_AA24  -to hdmi_red[2]
set_location_assignment PIN_AA28  -to hdmi_red[3]
set_location_assignment PIN_Y24   -to hdmi_red[4]
set_location_assignment PIN_W21   -to hdmi_red[5]
set_location_assignment PIN_W25   -to hdmi_red[6]
set_location_assignment PIN_V23   -to hdmi_red[7]

set_location_assignment PIN_AJ29  -to hdmi_grn[0]
set_location_assignment PIN_AD27  -to hdmi_grn[1]
set_location_assignment PIN_AH29  -to hdmi_grn[2]
set_location_assignment PIN_AD26  -to hdmi_grn[3]
set_location_assignment PIN_AG28  -to hdmi_grn[4]
set_location_assignment PIN_AE28  -to hdmi_grn[5]
set_location_assignment PIN_AG30  -to hdmi_grn[6]
set_location_assignment PIN_W20   -to hdmi_grn[7]

set_location_assignment PIN_AE26  -to hdmi_blu[0]
set_location_assignment PIN_W22   -to hdmi_blu[1]
set_location_assignment PIN_AE27  -to hdmi_blu[2]
set_location_assignment PIN_AA25  -to hdmi_blu[3]
set_location_assignment PIN_AG27  -to hdmi_blu[4]
set_location_assignment PIN_AB26  -to hdmi_blu[5]
set_location_assignment PIN_AH28  -to hdmi_blu[6]
set_location_assignment PIN_AC27  -to hdmi_blu[7]
...
set_instance_assignment -name IO_STANDARD "3.3-V LVTTL" -to hdmi_red[0]
set_instance_assignment -name IO_STANDARD "3.3-V LVTTL" -to hdmi_red[1]
set_instance_assignment -name IO_STANDARD "3.3-V LVTTL" -to hdmi_red[2]
set_instance_assignment -name IO_STANDARD "3.3-V LVTTL" -to hdmi_red[3]
set_instance_assignment -name IO_STANDARD "3.3-V LVTTL" -to hdmi_red[4]
set_instance_assignment -name IO_STANDARD "3.3-V LVTTL" -to hdmi_red[5]
set_instance_assignment -name IO_STANDARD "3.3-V LVTTL" -to hdmi_red[6]
set_instance_assignment -name IO_STANDARD "3.3-V LVTTL" -to hdmi_red[7]
set_instance_assignment -name IO_STANDARD "3.3-V LVTTL" -to hdmi_grn[0]
set_instance_assignment -name IO_STANDARD "3.3-V LVTTL" -to hdmi_grn[1]
set_instance_assignment -name IO_STANDARD "3.3-V LVTTL" -to hdmi_grn[2]
set_instance_assignment -name IO_STANDARD "3.3-V LVTTL" -to hdmi_grn[3]
set_instance_assignment -name IO_STANDARD "3.3-V LVTTL" -to hdmi_grn[4]
set_instance_assignment -name IO_STANDARD "3.3-V LVTTL" -to hdmi_grn[5]
set_instance_assignment -name IO_STANDARD "3.3-V LVTTL" -to hdmi_grn[6]
set_instance_assignment -name IO_STANDARD "3.3-V LVTTL" -to hdmi_grn[7]
set_instance_assignment -name IO_STANDARD "3.3-V LVTTL" -to hdmi_blu[0]
set_instance_assignment -name IO_STANDARD "3.3-V LVTTL" -to hdmi_blu[1]
set_instance_assignment -name IO_STANDARD "3.3-V LVTTL" -to hdmi_blu[2]
set_instance_assignment -name IO_STANDARD "3.3-V LVTTL" -to hdmi_blu[3]
set_instance_assignment -name IO_STANDARD "3.3-V LVTTL" -to hdmi_blu[4]
set_instance_assignment -name IO_STANDARD "3.3-V LVTTL" -to hdmi_blu[5]
set_instance_assignment -name IO_STANDARD "3.3-V LVTTL" -to hdmi_blu[6]
set_instance_assignment -name IO_STANDARD "3.3-V LVTTL" -to hdmi_blu[7]
...
set_instance_assignment -name IO_STANDARD "3.3-V LVTTL" -to usb_rst
