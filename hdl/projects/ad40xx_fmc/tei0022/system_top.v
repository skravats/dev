...
module system_top (
  ...
  system_bd i_system_bd (
    ...
    .vga_out_clk_clk (hdmi_clk),
    .vga_out_data_vid_clk (hdmi_clk),
    .vga_out_data_vid_data ({hdmi_red, hdmi_grn, hdmi_blu}),
    .vga_out_data_underflow (),
    .vga_out_data_vid_datavalid (hdmi_de),
    .vga_out_data_vid_v_sync (hdmi_vsync),
    .vga_out_data_vid_h_sync (hdmi_hsync),
    .vga_out_data_vid_f (),
    .vga_out_data_vid_h (),
    .vga_out_data_vid_v ());
