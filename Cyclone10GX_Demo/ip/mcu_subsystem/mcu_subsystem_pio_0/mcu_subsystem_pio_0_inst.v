	mcu_subsystem_pio_0 u0 (
		...
		.in_port    (_connected_to_in_port_),    //   input,  width = 32, external_connection.in_port
		.out_port   (_connected_to_out_port_),   //  output,  width = 32,                    .out_port
