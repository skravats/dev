// mcu_subsystem_xcvr_fpll_a10_0.v
...
module mcu_subsystem_xcvr_fpll_a10_0 (
	...
	altera_xcvr_fpll_a10 #(
		...
		.cmu_fpll_primary_use                                                         ("iqtxrx"),
		.cmu_fpll_prot_mode                                                           ("basic_tx"),
		.cmu_fpll_reference_clock_frequency_scratch                                   ("0 hz"),
		.cmu_fpll_side                                                                ("side_unknown"),
		.cmu_fpll_top_or_bottom                                                       ("bot"),
		.cmu_fpll_vco_freq_hz                                                         ("6400000000"),
		.cmu_fpll_vco_freq                                                            ("000101111101011110000100000000000000"),
		...
		.cmu_fpll_output_clock_frequency_1                                            ("200.0 MHz"),
		...
		.cmu_fpll_vco_frequency                                                       ("6400.0 MHz"),
		.cmu_fpll_cgb_div                                                             (1),
		...
		.cmu_fpll_f_out_c1                                                            ("000000001011111010111100001000000000"),
		...
		.cmu_fpll_pfd_freq                                                            ("000000000010111110101111000010000000"),
		...
		.hssi_pll_cascade_clk     (hssi_pll_cascade_clk),                 //  output,  width = 1, hssi_pll_cascade_clk.clk
