	component mcu_subsystem_nios_custom_instr_floating_point_2_0 is
		port (
	...
	end component mcu_subsystem_nios_custom_instr_floating_point_2_0;

	u0 : component mcu_subsystem_nios_custom_instr_floating_point_2_0
		port map (
