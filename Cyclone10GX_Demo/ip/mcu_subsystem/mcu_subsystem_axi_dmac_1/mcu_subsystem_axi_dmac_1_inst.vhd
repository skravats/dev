	component mcu_subsystem_axi_dmac_1 is
		port (
			...
			m_dest_axi_awlen   : out std_logic_vector(3 downto 0);                      -- awlen
			...
			m_dest_axi_arlen   : out std_logic_vector(3 downto 0);                      -- arlen
			...
			m_dest_axi_awid    : out std_logic;                                         -- awid
			m_dest_axi_awlock  : out std_logic_vector(1 downto 0);                      -- awlock
			m_dest_axi_wid     : out std_logic;                                         -- wid
			m_dest_axi_arid    : out std_logic;                                         -- arid
			m_dest_axi_arlock  : out std_logic_vector(1 downto 0);                      -- arlock
			m_dest_axi_rid     : in  std_logic                      := 'X';             -- rid
			m_dest_axi_bid     : in  std_logic                      := 'X';             -- bid
			m_dest_axi_rlast   : in  std_logic                      := 'X'              -- rlast
		);
	end component mcu_subsystem_axi_dmac_1;

	u0 : component mcu_subsystem_axi_dmac_1
		port map (
			...
			m_dest_axi_awid    => CONNECTED_TO_m_dest_axi_awid,    --                   .awid
			m_dest_axi_awlock  => CONNECTED_TO_m_dest_axi_awlock,  --                   .awlock
			m_dest_axi_wid     => CONNECTED_TO_m_dest_axi_wid,     --                   .wid
			m_dest_axi_arid    => CONNECTED_TO_m_dest_axi_arid,    --                   .arid
			m_dest_axi_arlock  => CONNECTED_TO_m_dest_axi_arlock,  --                   .arlock
			m_dest_axi_rid     => CONNECTED_TO_m_dest_axi_rid,     --                   .rid
			m_dest_axi_bid     => CONNECTED_TO_m_dest_axi_bid,     --                   .bid
			m_dest_axi_rlast   => CONNECTED_TO_m_dest_axi_rlast    --                   .rlast
		);
