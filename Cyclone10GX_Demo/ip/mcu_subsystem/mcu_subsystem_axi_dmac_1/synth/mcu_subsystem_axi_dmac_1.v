...
module mcu_subsystem_axi_dmac_1 (
	...
	axi_dmac #(
		...
		.m_dest_axi_awlen       (m_dest_axi_awlen),                                                                                                                      //  output,    width = 4,                   .awlen
		...
		.m_dest_axi_arlen       (m_dest_axi_arlen),                                                                                                                      //  output,    width = 4,                   .arlen
		...
		.m_dest_axi_awid        (m_dest_axi_awid),                                                                                                                       //  output,    width = 1,                   .awid
		.m_dest_axi_awlock      (m_dest_axi_awlock),                                                                                                                     //  output,    width = 2,                   .awlock
		.m_dest_axi_wid         (m_dest_axi_wid),                                                                                                                        //  output,    width = 1,                   .wid
		.m_dest_axi_arid        (m_dest_axi_arid),                                                                                                                       //  output,    width = 1,                   .arid
		.m_dest_axi_arlock      (m_dest_axi_arlock),                                                                                                                     //  output,    width = 2,                   .arlock
		.m_dest_axi_rid         (m_dest_axi_rid),                                                                                                                        //   input,    width = 1,                   .rid
		.m_dest_axi_bid         (m_dest_axi_bid),                                                                                                                        //   input,    width = 1,                   .bid
		.m_dest_axi_rlast       (m_dest_axi_rlast),                                                                                                                      //   input,    width = 1,                   .rlast
