module mcu_subsystem_axi_dmac_1 (
		...
		output wire [3:0]   m_dest_axi_awlen,   //                   .awlen
		...
		output wire [3:0]   m_dest_axi_arlen,   //                   .arlen
		...
		output wire         m_dest_axi_awid,    //                   .awid
		output wire [1:0]   m_dest_axi_awlock,  //                   .awlock
		output wire         m_dest_axi_wid,     //                   .wid
		output wire         m_dest_axi_arid,    //                   .arid
		output wire [1:0]   m_dest_axi_arlock,  //                   .arlock
		input  wire         m_dest_axi_rid,     //                   .rid
		input  wire         m_dest_axi_bid,     //                   .bid
		input  wire         m_dest_axi_rlast    //                   .rlast
	);
endmodule
