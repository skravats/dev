	mcu_subsystem_axi_dmac_1 u0 (
		...
		.m_dest_axi_awlen   (_connected_to_m_dest_axi_awlen_),   //  output,    width = 4,                   .awlen
		...
		.m_dest_axi_arlen   (_connected_to_m_dest_axi_arlen_),   //  output,    width = 4,                   .arlen
		...
		.m_dest_axi_awid    (_connected_to_m_dest_axi_awid_),    //  output,    width = 1,                   .awid
		.m_dest_axi_awlock  (_connected_to_m_dest_axi_awlock_),  //  output,    width = 2,                   .awlock
		.m_dest_axi_wid     (_connected_to_m_dest_axi_wid_),     //  output,    width = 1,                   .wid
		.m_dest_axi_arid    (_connected_to_m_dest_axi_arid_),    //  output,    width = 1,                   .arid
		.m_dest_axi_arlock  (_connected_to_m_dest_axi_arlock_),  //  output,    width = 2,                   .arlock
		.m_dest_axi_rid     (_connected_to_m_dest_axi_rid_),     //   input,    width = 1,                   .rid
		.m_dest_axi_bid     (_connected_to_m_dest_axi_bid_),     //   input,    width = 1,                   .bid
		.m_dest_axi_rlast   (_connected_to_m_dest_axi_rlast_)    //   input,    width = 1,                   .rlast
	);
