	component mcu_subsystem_mm_clock_crossing_bridge_2 is
		generic (
	...
	end component mcu_subsystem_mm_clock_crossing_bridge_2;

	u0 : component mcu_subsystem_mm_clock_crossing_bridge_2
		generic map (
