...
set ::GLOBAL_ddr3_altera_emif_arch_nf_181_rdy7veq_corename ddr3_altera_emif_arch_nf_181_rdy7veq

set var(PROTOCOL)                                                DDR3
set var(NUM_RANKS)                                               1
set var(SLEW_RATE_DRAM)                                          2.5
set var(SLEW_RATE_DRAM_CLOCK)                                    5.0
set var(VIN_Ms)                                                  0.13500000000000001
set var(VIN_Mh)                                                  0.089999999999999997
...
set var(UI)                                                      1.25
set var(tCK)                                                     1.25
set var(tDQSQ)                                                   0.10000000000000001
set var(tQH)                                                     0.38
set var(tDS)                                                     0.025000000000000001
set var(tDH)                                                     0.050000000000000003
set var(tIS)                                                     0.185
set var(tIH)                                                     0.13
set var(tDQSCK)                                                  0.14999999999999999
set var(tDQSS)                                                   0.27
set var(tWLS)                                                    0.16500000000000001
set var(tWLH)                                                    0.16500000000000001
set var(tDSS)                                                    0.18
set var(tDSH)                                                    0.18
...
set var(PHY_MEM_CLK_FREQ_MHZ)                                    800.0
set var(PHY_REF_CLK_FREQ_MHZ)                                    200.0
set var(PHY_REF_CLK_JITTER_PS)                                   10.0
set var(PLL_REF_CLK_FREQ_PS_STR)                                 "5000 ps"
set var(PLL_VCO_FREQ_PS_STR)                                     "1250 ps"
