...
---------------------
 ...
 19. Controller MMR slave interface 0
 20. Interface that allows the EMIF calibration processor to talk to its slave components
...
---------------------------------------------------
   ...
   mem_dm                         4       output      Write data mask
...
----------------------------------------------------
   ...
   amm_readdata_0                 256     output      Read data
   amm_writedata_0                256     input       Write data
   amm_burstcount_0               7       input       Number of transfers in each read/write burst
   amm_byteenable_0               32      input       Byte-enable for write data
...
-----------------------------------------
   ...
   Port                           Width   Direction   Description                                        
   ------------------------------------------------------------------------------------------------------
   mmr_slave_waitrequest_0        1       output      Wait-request is asserted when controller MMR interface is busy
   mmr_slave_read_0               1       input       MMR read request signal
   mmr_slave_write_0              1       input       MMR write request signal
   mmr_slave_address_0            10      input       Word address for MMR interface of memory controller
   mmr_slave_readdata_0           32      output      MMR read data
   mmr_slave_writedata_0          32      input       MMR write data
   mmr_slave_burstcount_0         2       input       Number of transfers in each read/write burst
   mmr_slave_beginbursttransfer_0 1       input       Indicates when a burst is starting
   mmr_slave_readdatavalid_0      1       output      Indicates whether MMR read data is valid
...
------------------------------------------------------------
   ...
   The RTL simulation behavior of the current IP is "Full Calibration"
...
--------------------
   ...
   PHY_AC_IO_STD_ENUM                                : IO_STD_SSTL_135_C1
   PHY_CK_IO_STD_ENUM                                : IO_STD_SSTL_135_C1
   PHY_DATA_IO_STD_ENUM                              : IO_STD_SSTL_135
   ...
   PLL_EXTRA_CLK_ACTUAL_FREQ_MHZ_5                   : 800.0
   PLL_EXTRA_CLK_ACTUAL_PHASE_PS_5                   : 0.0
   PLL_EXTRA_CLK_ACTUAL_FREQ_MHZ_6                   : 800.0
   PLL_EXTRA_CLK_ACTUAL_PHASE_PS_6                   : 0.0
   PLL_EXTRA_CLK_ACTUAL_FREQ_MHZ_7                   : 800.0
   PLL_EXTRA_CLK_ACTUAL_PHASE_PS_7                   : 0.0
   PLL_EXTRA_CLK_ACTUAL_FREQ_MHZ_8                   : 800.0
   ...
   PHY_DDR3_AC_IO_STD_ENUM                           : IO_STD_SSTL_135_C1
   PHY_DDR3_AC_MODE_ENUM                             : CURRENT_ST_12
   PHY_DDR3_AC_SLEW_RATE_ENUM                        : SLEW_RATE_SLOW
   PHY_DDR3_CK_IO_STD_ENUM                           : IO_STD_SSTL_135_C1
   PHY_DDR3_CK_MODE_ENUM                             : CURRENT_ST_12
   PHY_DDR3_CK_SLEW_RATE_ENUM                        : SLEW_RATE_SLOW
   PHY_DDR3_DATA_IO_STD_ENUM                         : IO_STD_SSTL_135
   ...
   PHY_DDR3_RZQ_IO_STD_ENUM                          : IO_STD_SSTL_135
   ...
   MEM_DDR3_HIDE_ADV_MR_SETTINGS                     : false
   ...
   MEM_DDR3_TTL_DQS_WIDTH                            : 4
   MEM_DDR3_TTL_DQ_WIDTH                             : 32
   MEM_DDR3_TTL_DM_WIDTH                             : 4
   ...
   MEM_DDR3_MR0                                      : 0xc70
   MEM_DDR3_MR1                                      : 0x10016
   MEM_DDR3_MR2                                      : 0x20258
   ...
   MEM_DDR3_WTCL                                     : 8
   MEM_DDR3_ATCL_ENUM                                : DDR3_ATCL_CL2
   MEM_DDR3_TCL                                      : 11
   ...
   MEM_DDR3_SPEEDBIN_ENUM                            : DDR3_SPEEDBIN_1600
   MEM_DDR3_TIS_PS                                   : 185
   MEM_DDR3_TIS_AC_MV                                : 135
   MEM_DDR3_TIH_PS                                   : 130
   MEM_DDR3_TIH_DC_MV                                : 90
   MEM_DDR3_TDS_PS                                   : 25
   MEM_DDR3_TDS_AC_MV                                : 135
   MEM_DDR3_TDH_PS                                   : 50
   MEM_DDR3_TDH_DC_MV                                : 90
   MEM_DDR3_TDQSQ_PS                                 : 100
   MEM_DDR3_TQH_CYC                                  : 0.38
   MEM_DDR3_TDQSCK_PS                                : 150
   MEM_DDR3_TDQSS_CYC                                : 0.27
   MEM_DDR3_TQSH_CYC                                 : 0.4
   MEM_DDR3_TDSH_CYC                                 : 0.18
   MEM_DDR3_TWLS_PS                                  : 165.0
   MEM_DDR3_TWLH_PS                                  : 165.0
   MEM_DDR3_TDSS_CYC                                 : 0.18
   MEM_DDR3_TINIT_US                                 : 500
   MEM_DDR3_TMRD_CK_CYC                              : 4
   MEM_DDR3_TRAS_NS                                  : 35.0
   MEM_DDR3_TRCD_NS                                  : 13.75
   MEM_DDR3_TRP_NS                                   : 13.75
   MEM_DDR3_TREFI_US                                 : 4.0
   MEM_DDR3_TRFC_NS                                  : 350.0
   MEM_DDR3_TWR_NS                                   : 15.0
   MEM_DDR3_TWTR_CYC                                 : 4
   MEM_DDR3_TFAW_NS                                  : 40.0
   MEM_DDR3_TRRD_CYC                                 : 4
   MEM_DDR3_TRTP_CYC                                 : 4
   ...
   MEM_DDR3_TRAS_CYC                                 : 28
   MEM_DDR3_TRCD_CYC                                 : 11
   MEM_DDR3_TRP_CYC                                  : 11
   MEM_DDR3_TRFC_CYC                                 : 280
   MEM_DDR3_TWR_CYC                                  : 12
   MEM_DDR3_TFAW_CYC                                 : 32
   MEM_DDR3_TREFI_CYC                                : 3200
   ...
   DIAG_EXT_DOCS                                     : false
   DIAG_SIM_CAL_MODE_ENUM                            : SIM_CAL_MODE_FULL
   ...
   DIAG_DDR3_SIM_CAL_MODE_ENUM                       : SIM_CAL_MODE_FULL
