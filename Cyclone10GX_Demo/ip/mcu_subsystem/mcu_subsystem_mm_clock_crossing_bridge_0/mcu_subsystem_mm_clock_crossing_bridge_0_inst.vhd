	component mcu_subsystem_mm_clock_crossing_bridge_0 is
		generic (
	...
	end component mcu_subsystem_mm_clock_crossing_bridge_0;

	u0 : component mcu_subsystem_mm_clock_crossing_bridge_0
		generic map (
