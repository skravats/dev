...
`timescale 1 ps / 1 ps
module mcu_subsystem_generic_quad_spi_controller2_0_altera_asmi2_csr_controller_181_spl33la #(
	...
	localparam  CSR_MISC_EN_17  = 0;
	localparam  CSR_MISC_WR_ONLY_17 = 1;
	localparam  CSR_MISC_EN_18  = 1;
	...
	assign header_mem[17]	= 32'b00000000000000000000000000000000;
	assign header_mem[18]	= 32'b00000000000000000000001111000100;
...
// output_name 					: mcu_subsystem_generic_quad_spi_controller2_0_altera_asmi2_csr_controller_181_spl33la
...
// misc_op_name   				: wr_NVCR rd_NVCR rd_flag_status clr_flag_status NA die_erase 4bytes_addr_en 4bytes_addr_ex sector_protect rd_device_id
// misc_op_opcode 				: B1 B5 70 50 00 C4 B7 E9 01 9F
// misc_op_addr_bytes    		: 0 0 0 0 0 4 0 0 0 0
