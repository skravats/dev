	component mcu_subsystem_axi_dmac_0 is
		port (
	...
	end component mcu_subsystem_axi_dmac_0;

	u0 : component mcu_subsystem_axi_dmac_0
		port map (
			...
			m_axis_valid      => CONNECTED_TO_m_axis_valid,      --    if_m_axis_valid.valid
			m_axis_data       => CONNECTED_TO_m_axis_data,       --     if_m_axis_data.data
			m_axis_ready      => CONNECTED_TO_m_axis_ready,      --    if_m_axis_ready.ready
			m_axis_last       => CONNECTED_TO_m_axis_last,       --     if_m_axis_last.last
