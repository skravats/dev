	...
	end component ad9144_jesd204;

	u0 : component ad9144_jesd204
		port map (
			...
			serial_data_tx_serial_data    => CONNECTED_TO_serial_data_tx_serial_data,    --       serial_data.tx_serial_data
			...
			lane_pll_reconfig_write       => CONNECTED_TO_lane_pll_reconfig_write,       -- lane_pll_reconfig.write
			lane_pll_reconfig_read        => CONNECTED_TO_lane_pll_reconfig_read,        --                  .read
			lane_pll_reconfig_address     => CONNECTED_TO_lane_pll_reconfig_address,     --                  .address
			lane_pll_reconfig_writedata   => CONNECTED_TO_lane_pll_reconfig_writedata,   --                  .writedata
			lane_pll_reconfig_readdata    => CONNECTED_TO_lane_pll_reconfig_readdata,    --                  .readdata
			lane_pll_reconfig_waitrequest => CONNECTED_TO_lane_pll_reconfig_waitrequest, --                  .waitrequest
			...
			link_data_ready               => CONNECTED_TO_link_data_ready,               --                  .ready
