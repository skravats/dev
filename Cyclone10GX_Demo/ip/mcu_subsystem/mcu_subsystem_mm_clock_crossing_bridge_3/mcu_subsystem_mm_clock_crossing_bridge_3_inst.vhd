	component mcu_subsystem_mm_clock_crossing_bridge_3 is
		generic (
	...
	end component mcu_subsystem_mm_clock_crossing_bridge_3;

	u0 : component mcu_subsystem_mm_clock_crossing_bridge_3
		generic map (
