...
set ::GLOBAL_ddr_controller_altera_emif_arch_nf_181_ygvy23y_corename ddr_controller_altera_emif_arch_nf_181_ygvy23y

set var(PROTOCOL)                                                DDR3
set var(NUM_RANKS)                                               1
set var(SLEW_RATE_DRAM)                                          2.5
set var(SLEW_RATE_DRAM_CLOCK)                                    5.0
set var(VIN_Ms)                                                  0.175
set var(VIN_Mh)                                                  0.1
