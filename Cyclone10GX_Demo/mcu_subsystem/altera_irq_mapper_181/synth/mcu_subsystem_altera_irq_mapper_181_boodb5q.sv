...
//   NUM_RCVRS        : 14
//   SENDER_IRW_WIDTH : 32
//   IRQ_MAP          : 0:8,1:10,2:0,3:9,4:11,5:13,6:1,7:2,8:3,9:12,10:4,11:6,12:5,13:7
//
// -------------------------------------------------------

`timescale 1 ns / 1 ns

module mcu_subsystem_altera_irq_mapper_181_boodb5q
(
    // -------------------
    // Clock & Reset
    // -------------------
	...
	sender_irq = 0;
        ...
        sender_irq[5] = receiver12_irq;
        sender_irq[7] = receiver13_irq;
    end
