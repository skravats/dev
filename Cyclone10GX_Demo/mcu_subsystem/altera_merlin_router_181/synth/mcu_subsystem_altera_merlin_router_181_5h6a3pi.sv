...
module mcu_subsystem_altera_merlin_router_181_5h6a3pi_default_decode
  #(
...
module mcu_subsystem_altera_merlin_router_181_5h6a3pi
(
    // -------------------
    // Clock & Reset
    // -------------------
    ...
    localparam PAD10 = log2ceil(64'h23000 - 64'h22000); 
    localparam PAD11 = log2ceil(64'h24000 - 64'h23000); 
    localparam PAD12 = log2ceil(64'h28000 - 64'h24000); 
    localparam PAD13 = log2ceil(64'h28000 - 64'h24000); 
    localparam PAD14 = log2ceil(64'h2c000 - 64'h28000); 
    localparam PAD15 = log2ceil(64'h2c000 - 64'h28000); 
    localparam PAD16 = log2ceil(64'h2d000 - 64'h2c000); 
    localparam PAD17 = log2ceil(64'h2e000 - 64'h2d000); 
    localparam PAD18 = log2ceil(64'h2e000 - 64'h2d000); 
    localparam PAD19 = log2ceil(64'h2f000 - 64'h2e000); 
    localparam PAD20 = log2ceil(64'h2f000 - 64'h2e000); 
    localparam PAD21 = log2ceil(64'h30000 - 64'h2f000); 
    localparam PAD22 = log2ceil(64'h40000 - 64'h30000); 
    localparam PAD23 = log2ceil(64'h40000 - 64'h30000); 
    localparam PAD24 = log2ceil(64'h50000 - 64'h40000); 
    localparam PAD25 = log2ceil(64'h50000 - 64'h40000); 
    localparam PAD26 = log2ceil(64'h51000 - 64'h50000); 
    localparam PAD27 = log2ceil(64'h52000 - 64'h51000); 
    localparam PAD28 = log2ceil(64'h53000 - 64'h52000); 
    localparam PAD29 = log2ceil(64'h54000 - 64'h53000); 
    localparam PAD30 = log2ceil(64'h55000 - 64'h54000); 
    localparam PAD31 = log2ceil(64'h56000 - 64'h55000); 
    localparam PAD32 = log2ceil(64'h57000 - 64'h56000); 
    localparam PAD33 = log2ceil(64'h58000 - 64'h57000); 
    localparam PAD34 = log2ceil(64'h59000 - 64'h58000); 
    localparam PAD35 = log2ceil(64'h5a000 - 64'h59000); 
    localparam PAD36 = log2ceil(64'h5a000 - 64'h59000); 
    localparam PAD37 = log2ceil(64'h5b000 - 64'h5a000); 
    localparam PAD38 = log2ceil(64'h5b000 - 64'h5a000); 
    localparam PAD39 = log2ceil(64'h5c000 - 64'h5b000); 
    localparam PAD40 = log2ceil(64'h10000000 - 64'h8000000); 
    localparam PAD41 = log2ceil(64'h100000000 - 64'h80000000); 
    // -------------------------------------------------------
    ...
    mcu_subsystem_altera_merlin_router_181_5h6a3pi_default_decode the_default_decode(
