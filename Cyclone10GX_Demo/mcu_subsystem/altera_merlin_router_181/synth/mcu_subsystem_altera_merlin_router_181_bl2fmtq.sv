...
module mcu_subsystem_altera_merlin_router_181_bl2fmtq_default_decode
  #(
...
module mcu_subsystem_altera_merlin_router_181_bl2fmtq
(
    // -------------------
    // Clock & Reset
    // -------------------
    ...
    mcu_subsystem_altera_merlin_router_181_bl2fmtq_default_decode the_default_decode(
