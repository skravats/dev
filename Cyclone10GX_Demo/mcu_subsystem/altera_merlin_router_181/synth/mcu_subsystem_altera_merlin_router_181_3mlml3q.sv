...
module mcu_subsystem_altera_merlin_router_181_3mlml3q_default_decode
  #(
...
module mcu_subsystem_altera_merlin_router_181_3mlml3q
(
    // -------------------
    // Clock & Reset
    // -------------------
    ...
    mcu_subsystem_altera_merlin_router_181_3mlml3q_default_decode the_default_decode(
    ...
    always @* begin
        ...
        if (destid == 0 ) begin
            src_channel = 42'b0001;
        end

        if (destid == 1  && read_transaction) begin
            src_channel = 42'b0010;
        end

        if (destid == 2 ) begin
            src_channel = 42'b0100;
        end

        if (destid == 3 ) begin
            src_channel = 42'b1000;
        end
