...
module mcu_subsystem_altera_merlin_router_181_sdbjfjy_default_decode
  #(
...
module mcu_subsystem_altera_merlin_router_181_sdbjfjy
(
    // -------------------
    // Clock & Reset
    // -------------------
    ...
    mcu_subsystem_altera_merlin_router_181_sdbjfjy_default_decode the_default_decode(
