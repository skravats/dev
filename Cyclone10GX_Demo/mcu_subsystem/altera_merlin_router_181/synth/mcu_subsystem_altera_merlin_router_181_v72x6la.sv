...
module mcu_subsystem_altera_merlin_router_181_v72x6la_default_decode
  #(
...
module mcu_subsystem_altera_merlin_router_181_v72x6la
(
    // -------------------
    // Clock & Reset
    // -------------------
    ...
    localparam PAD31 = log2ceil(64'h100000000 - 64'h80000000); 
    // -------------------------------------------------------
    ...
    mcu_subsystem_altera_merlin_router_181_v72x6la_default_decode the_default_decode(
    ...
    // ( 0x51000 .. 0x52000 )
    if ( {address[RG:PAD25],{PAD25{1'b0}}} == 32'h51000  && write_transaction  ) begin
            src_channel = 32'b00000000000000000000000000000100;
            src_data[PKT_DEST_ID_H:PKT_DEST_ID_L] = 8;
    end

    // ( 0x51000 .. 0x52000 )
    if ( {address[RG:PAD26],{PAD26{1'b0}}} == 32'h51000  && read_transaction  ) begin
            src_channel = 32'b00000000000000000000000000001000;
            src_data[PKT_DEST_ID_H:PKT_DEST_ID_L] = 8;
    end

    // ( 0x52000 .. 0x53000 )
    if ( {address[RG:PAD27],{PAD27{1'b0}}} == 32'h52000  && write_transaction  ) begin
            src_channel = 32'b00000000000000000000000000000001;
            src_data[PKT_DEST_ID_H:PKT_DEST_ID_L] = 2;
    end

    // ( 0x52000 .. 0x53000 )
    if ( {address[RG:PAD28],{PAD28{1'b0}}} == 32'h52000  && read_transaction  ) begin
    ...
    if ( {address[RG:PAD30],{PAD30{1'b0}}} == 32'h8000000   ) begin
            src_channel = 32'b00000001000000000000000000000000;
            src_data[PKT_DEST_ID_H:PKT_DEST_ID_L] = 14;
    end

    // ( 0x80000000 .. 0x100000000 )
    if ( {address[RG:PAD31],{PAD31{1'b0}}} == 32'h80000000   ) begin
