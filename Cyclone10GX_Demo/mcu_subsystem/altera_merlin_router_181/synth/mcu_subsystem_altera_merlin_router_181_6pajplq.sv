...
module mcu_subsystem_altera_merlin_router_181_6pajplq_default_decode
  #(
...
module mcu_subsystem_altera_merlin_router_181_6pajplq
(
    // -------------------
    // Clock & Reset
    // -------------------
    ...
    localparam PAD3 = log2ceil(64'h23000 - 64'h22000); 
    localparam PAD4 = log2ceil(64'h10000000 - 64'h8000000); 
    localparam PAD5 = log2ceil(64'h100000000 - 64'h80000000); 
    // -------------------------------------------------------
    ...
    mcu_subsystem_altera_merlin_router_181_6pajplq_default_decode the_default_decode(
    ...
    // ( 0x21040 .. 0x21080 )
    if ( {address[RG:PAD2],{PAD2{1'b0}}} == 32'h21040   ) begin
            src_channel = 43'b001000;
            src_data[PKT_DEST_ID_H:PKT_DEST_ID_L] = 21;
    end

    // ( 0x22000 .. 0x23000 )
    if ( {address[RG:PAD3],{PAD3{1'b0}}} == 32'h22000   ) begin
    ...
    if ( {address[RG:PAD5],{PAD5{1'b0}}} == 32'h80000000   ) begin
