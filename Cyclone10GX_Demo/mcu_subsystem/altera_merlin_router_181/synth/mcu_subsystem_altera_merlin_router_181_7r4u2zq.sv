...
module mcu_subsystem_altera_merlin_router_181_7r4u2zq_default_decode
  #(
...
module mcu_subsystem_altera_merlin_router_181_7r4u2zq
(
    // -------------------
    // Clock & Reset
    // -------------------
    ...
    mcu_subsystem_altera_merlin_router_181_7r4u2zq_default_decode the_default_decode(
