// mcu_subsystem_altera_mm_interconnect_181_74snbbq.v
...
`timescale 1 ps / 1 ps
module mcu_subsystem_altera_mm_interconnect_181_74snbbq (
		...
		output wire [25:0]  sdram_ctrl_amm_0_address,                                //                                  sdram_ctrl_amm_0.address
		output wire         sdram_ctrl_amm_0_write,                                  //                                                  .write
		output wire         sdram_ctrl_amm_0_read,                                   //                                                  .read
		input  wire [255:0] sdram_ctrl_amm_0_readdata,                               //                                                  .readdata
		output wire [255:0] sdram_ctrl_amm_0_writedata,                              //                                                  .writedata
		output wire [6:0]   sdram_ctrl_amm_0_burstcount,                             //                                                  .burstcount
		output wire [31:0]  sdram_ctrl_amm_0_byteenable,                             //                                                  .byteenable
	...
	wire  [255:0] sdram_ctrl_amm_0_agent_m0_readdata;                             // sdram_ctrl_amm_0_translator:uav_readdata -> sdram_ctrl_amm_0_agent:m0_readdata
	...
	wire   [31:0] sdram_ctrl_amm_0_agent_m0_byteenable;                           // sdram_ctrl_amm_0_agent:m0_byteenable -> sdram_ctrl_amm_0_translator:uav_byteenable
	...
	wire  [255:0] sdram_ctrl_amm_0_agent_m0_writedata;                            // sdram_ctrl_amm_0_agent:m0_writedata -> sdram_ctrl_amm_0_translator:uav_writedata
	wire          sdram_ctrl_amm_0_agent_m0_write;                                // sdram_ctrl_amm_0_agent:m0_write -> sdram_ctrl_amm_0_translator:uav_write
	wire   [11:0] sdram_ctrl_amm_0_agent_m0_burstcount;                           // sdram_ctrl_amm_0_agent:m0_burstcount -> sdram_ctrl_amm_0_translator:uav_burstcount
	...
	wire  [383:0] sdram_ctrl_amm_0_agent_rf_source_data;                          // sdram_ctrl_amm_0_agent:rf_source_data -> sdram_ctrl_amm_0_agent_rsp_fifo:in_data
	...
	wire  [383:0] sdram_ctrl_amm_0_agent_rsp_fifo_out_data;                       // sdram_ctrl_amm_0_agent_rsp_fifo:out_data -> sdram_ctrl_amm_0_agent:rf_sink_data
	...
	wire  [257:0] sdram_ctrl_amm_0_agent_rdata_fifo_src_data;                     // sdram_ctrl_amm_0_agent:rdata_fifo_src_data -> sdram_ctrl_amm_0_agent_rdata_fifo:in_data
	...
	wire  [257:0] sdram_ctrl_amm_0_agent_rdata_fifo_out_data;                     // sdram_ctrl_amm_0_agent_rdata_fifo:out_data -> sdram_ctrl_amm_0_agent:rdata_fifo_sink_data
	...
	wire          sdram_ctrl_amm_0_agent_rp_valid;                                // sdram_ctrl_amm_0_agent:rp_valid -> router_005:sink_valid
	wire  [382:0] sdram_ctrl_amm_0_agent_rp_data;                                 // sdram_ctrl_amm_0_agent:rp_data -> router_005:sink_data
	wire          sdram_ctrl_amm_0_agent_rp_ready;                                // router_005:sink_ready -> sdram_ctrl_amm_0_agent:rp_ready
	wire          sdram_ctrl_amm_0_agent_rp_startofpacket;                        // sdram_ctrl_amm_0_agent:rp_startofpacket -> router_005:sink_startofpacket
	wire          sdram_ctrl_amm_0_agent_rp_endofpacket;                          // sdram_ctrl_amm_0_agent:rp_endofpacket -> router_005:sink_endofpacket
	...
	wire          cmd_mux_src_valid;                                              // cmd_mux:src_valid -> sdram_ctrl_amm_0_burst_adapter:sink0_valid
	wire  [382:0] cmd_mux_src_data;                                               // cmd_mux:src_data -> sdram_ctrl_amm_0_burst_adapter:sink0_data
	wire          cmd_mux_src_ready;                                              // sdram_ctrl_amm_0_burst_adapter:sink0_ready -> cmd_mux:src_ready
	wire    [4:0] cmd_mux_src_channel;                                            // cmd_mux:src_channel -> sdram_ctrl_amm_0_burst_adapter:sink0_channel
	wire          cmd_mux_src_startofpacket;                                      // cmd_mux:src_startofpacket -> sdram_ctrl_amm_0_burst_adapter:sink0_startofpacket
	wire          cmd_mux_src_endofpacket;                                        // cmd_mux:src_endofpacket -> sdram_ctrl_amm_0_burst_adapter:sink0_endofpacket
	...
	wire  [382:0] sdram_ctrl_amm_0_burst_adapter_source0_data;                    // sdram_ctrl_amm_0_burst_adapter:source0_data -> sdram_ctrl_amm_0_agent:cp_data
	...
	wire    [4:0] sdram_ctrl_amm_0_burst_adapter_source0_channel;                 // sdram_ctrl_amm_0_burst_adapter:source0_channel -> sdram_ctrl_amm_0_agent:cp_channel
	...
	mcu_subsystem_altera_merlin_slave_translator_181_5aswt6a #(
		...
		.uav_burstcount         (sdram_ctrl_amm_0_agent_m0_burstcount),          //   input,   width = 12,                         .burstcount
		...
		.uav_byteenable         (sdram_ctrl_amm_0_agent_m0_byteenable),          //   input,   width = 32,                         .byteenable
		.uav_readdata           (sdram_ctrl_amm_0_agent_m0_readdata),            //  output,  width = 256,                         .readdata
		.uav_writedata          (sdram_ctrl_amm_0_agent_m0_writedata),           //   input,  width = 256,                         .writedata
		...
		.av_address             (sdram_ctrl_amm_0_address),                      //  output,   width = 26,      avalon_anti_slave_0.address
		.av_write               (sdram_ctrl_amm_0_write),                        //  output,    width = 1,                         .write
		.av_read                (sdram_ctrl_amm_0_read),                         //  output,    width = 1,                         .read
		.av_readdata            (sdram_ctrl_amm_0_readdata),                     //   input,  width = 256,                         .readdata
		.av_writedata           (sdram_ctrl_amm_0_writedata),                    //  output,  width = 256,                         .writedata
		.av_burstcount          (sdram_ctrl_amm_0_burstcount),                   //  output,    width = 7,                         .burstcount
		.av_byteenable          (sdram_ctrl_amm_0_byteenable),                   //  output,   width = 32,                         .byteenable
	...
	mcu_subsystem_altera_merlin_slave_agent_181_a7g37xa #(
		...
		.m0_burstcount           (sdram_ctrl_amm_0_agent_m0_burstcount),                 //  output,   width = 12,                .burstcount
		.m0_byteenable           (sdram_ctrl_amm_0_agent_m0_byteenable),                 //  output,   width = 32,                .byteenable
		...
		.m0_readdata             (sdram_ctrl_amm_0_agent_m0_readdata),                   //   input,  width = 256,                .readdata
		...
		.m0_writedata            (sdram_ctrl_amm_0_agent_m0_writedata),                  //  output,  width = 256,                .writedata
		...
		.rp_data                 (sdram_ctrl_amm_0_agent_rp_data),                       //  output,  width = 383,                .data
		...
		.cp_data                 (sdram_ctrl_amm_0_burst_adapter_source0_data),          //   input,  width = 383,                .data
		...
		.cp_channel              (sdram_ctrl_amm_0_burst_adapter_source0_channel),       //   input,    width = 5,                .channel
		...
		.rf_sink_data            (sdram_ctrl_amm_0_agent_rsp_fifo_out_data),             //   input,  width = 384,                .data
		...
		.rf_source_data          (sdram_ctrl_amm_0_agent_rf_source_data),                //  output,  width = 384,                .data
		...
		.rdata_fifo_sink_data    (sdram_ctrl_amm_0_agent_rdata_fifo_out_data),           //   input,  width = 258,                .data
		...
		.rdata_fifo_src_data     (sdram_ctrl_amm_0_agent_rdata_fifo_src_data),           //  output,  width = 258,                .data
	...
	mcu_subsystem_altera_avalon_sc_fifo_181_oywqgnq #(
		...
		.clk               (sdram_emif_usr_clk_clk),                            //   input,    width = 1,       clk.clk
		.reset             (bridge_0_m0_reset_reset_bridge_in_reset_reset),     //   input,    width = 1, clk_reset.reset
		.in_data           (sdram_ctrl_amm_0_agent_rf_source_data),             //   input,  width = 384,        in.data
		...
		.out_data          (sdram_ctrl_amm_0_agent_rsp_fifo_out_data),          //  output,  width = 384,       out.data
	...
	mcu_subsystem_altera_avalon_sc_fifo_181_oywqgnq #(
		...
		.clk               (sdram_emif_usr_clk_clk),                        //   input,    width = 1,       clk.clk
		.reset             (bridge_0_m0_reset_reset_bridge_in_reset_reset), //   input,    width = 1, clk_reset.reset
		.in_data           (sdram_ctrl_amm_0_agent_rdata_fifo_src_data),    //   input,  width = 258,        in.data
		...
		.out_data          (sdram_ctrl_amm_0_agent_rdata_fifo_out_data),    //  output,  width = 258,       out.data
	...
	mcu_subsystem_altera_merlin_router_181_vqbjw3i router_005 (
		...
		.sink_data          (sdram_ctrl_amm_0_agent_rp_data),                //   input,  width = 383,          .data
	...
	mcu_subsystem_altera_merlin_burst_adapter_181_h2pzzaa #(
		...
		.source0_data          (sdram_ctrl_amm_0_burst_adapter_source0_data),          //  output,  width = 383,          .data
		.source0_channel       (sdram_ctrl_amm_0_burst_adapter_source0_channel),       //  output,    width = 5,          .channel
