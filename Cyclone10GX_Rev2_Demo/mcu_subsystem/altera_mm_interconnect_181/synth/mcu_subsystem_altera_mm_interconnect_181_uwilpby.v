// mcu_subsystem_altera_mm_interconnect_181_uwilpby.v
...
`timescale 1 ps / 1 ps
module mcu_subsystem_altera_mm_interconnect_181_uwilpby (
	...
	wire   [11:0] bridge_0_m0_translator_avalon_universal_master_0_burstcount;    // bridge_0_m0_translator:uav_burstcount -> bridge_0_m0_agent:av_burstcount
	...
	wire          ddr3_ctrl_amm_0_burst_adapter_source0_valid;                    // ddr3_ctrl_amm_0_burst_adapter:source0_valid -> ddr3_ctrl_amm_0_agent:cp_valid
	wire  [370:0] ddr3_ctrl_amm_0_burst_adapter_source0_data;                     // ddr3_ctrl_amm_0_burst_adapter:source0_data -> ddr3_ctrl_amm_0_agent:cp_data
	wire          ddr3_ctrl_amm_0_burst_adapter_source0_ready;                    // ddr3_ctrl_amm_0_agent:cp_ready -> ddr3_ctrl_amm_0_burst_adapter:source0_ready
	wire    [0:0] ddr3_ctrl_amm_0_burst_adapter_source0_channel;                  // ddr3_ctrl_amm_0_burst_adapter:source0_channel -> ddr3_ctrl_amm_0_agent:cp_channel
	wire          ddr3_ctrl_amm_0_burst_adapter_source0_startofpacket;            // ddr3_ctrl_amm_0_burst_adapter:source0_startofpacket -> ddr3_ctrl_amm_0_agent:cp_startofpacket
	wire          ddr3_ctrl_amm_0_burst_adapter_source0_endofpacket;              // ddr3_ctrl_amm_0_burst_adapter:source0_endofpacket -> ddr3_ctrl_amm_0_agent:cp_endofpacket
	...
	wire          ddr3_ctrl_amm_0_cmd_width_adapter_src_valid;                    // ddr3_ctrl_amm_0_cmd_width_adapter:out_valid -> ddr3_ctrl_amm_0_burst_adapter:sink0_valid
	wire  [370:0] ddr3_ctrl_amm_0_cmd_width_adapter_src_data;                     // ddr3_ctrl_amm_0_cmd_width_adapter:out_data -> ddr3_ctrl_amm_0_burst_adapter:sink0_data
	wire          ddr3_ctrl_amm_0_cmd_width_adapter_src_ready;                    // ddr3_ctrl_amm_0_burst_adapter:sink0_ready -> ddr3_ctrl_amm_0_cmd_width_adapter:out_ready
	wire    [0:0] ddr3_ctrl_amm_0_cmd_width_adapter_src_channel;                  // ddr3_ctrl_amm_0_cmd_width_adapter:out_channel -> ddr3_ctrl_amm_0_burst_adapter:sink0_channel
	wire          ddr3_ctrl_amm_0_cmd_width_adapter_src_startofpacket;            // ddr3_ctrl_amm_0_cmd_width_adapter:out_startofpacket -> ddr3_ctrl_amm_0_burst_adapter:sink0_startofpacket
	wire          ddr3_ctrl_amm_0_cmd_width_adapter_src_endofpacket;              // ddr3_ctrl_amm_0_cmd_width_adapter:out_endofpacket -> ddr3_ctrl_amm_0_burst_adapter:sink0_endofpacket
	...
	mcu_subsystem_altera_merlin_master_translator_181_mhudjri #(
		...
		.uav_burstcount         (bridge_0_m0_translator_avalon_universal_master_0_burstcount),    //  output,   width = 12,                          .burstcount
	...
	mcu_subsystem_altera_merlin_master_agent_181_t5eyqrq #(
		...
		.av_burstcount         (bridge_0_m0_translator_avalon_universal_master_0_burstcount),    //   input,   width = 12,          .burstcount
	...
	mcu_subsystem_altera_merlin_slave_agent_181_a7g37xa #(
		...
		.cp_ready                (ddr3_ctrl_amm_0_burst_adapter_source0_ready),         //  output,    width = 1,              cp.ready
		.cp_valid                (ddr3_ctrl_amm_0_burst_adapter_source0_valid),         //   input,    width = 1,                .valid
		.cp_data                 (ddr3_ctrl_amm_0_burst_adapter_source0_data),          //   input,  width = 371,                .data
		.cp_startofpacket        (ddr3_ctrl_amm_0_burst_adapter_source0_startofpacket), //   input,    width = 1,                .startofpacket
		.cp_endofpacket          (ddr3_ctrl_amm_0_burst_adapter_source0_endofpacket),   //   input,    width = 1,                .endofpacket
		.cp_channel              (ddr3_ctrl_amm_0_burst_adapter_source0_channel),       //   input,    width = 1,                .channel
	...
	mcu_subsystem_altera_merlin_burst_adapter_181_kgo66yi #(
		.PKT_ADDR_H                (318),
		.PKT_ADDR_L                (288),
		.PKT_BEGIN_BURST           (345),
		.PKT_BYTE_CNT_H            (336),
		...
		.sink0_valid           (ddr3_ctrl_amm_0_cmd_width_adapter_src_valid),         //   input,    width = 1,     sink0.valid
		.sink0_data            (ddr3_ctrl_amm_0_cmd_width_adapter_src_data),          //   input,  width = 371,          .data
		.sink0_channel         (ddr3_ctrl_amm_0_cmd_width_adapter_src_channel),       //   input,    width = 1,          .channel
		.sink0_startofpacket   (ddr3_ctrl_amm_0_cmd_width_adapter_src_startofpacket), //   input,    width = 1,          .startofpacket
		.sink0_endofpacket     (ddr3_ctrl_amm_0_cmd_width_adapter_src_endofpacket),   //   input,    width = 1,          .endofpacket
		.sink0_ready           (ddr3_ctrl_amm_0_cmd_width_adapter_src_ready),         //  output,    width = 1,          .ready
		.source0_valid         (ddr3_ctrl_amm_0_burst_adapter_source0_valid),         //  output,    width = 1,   source0.valid
		.source0_data          (ddr3_ctrl_amm_0_burst_adapter_source0_data),          //  output,  width = 371,          .data
		.source0_channel       (ddr3_ctrl_amm_0_burst_adapter_source0_channel),       //  output,    width = 1,          .channel
		.source0_startofpacket (ddr3_ctrl_amm_0_burst_adapter_source0_startofpacket), //  output,    width = 1,          .startofpacket
		.source0_endofpacket   (ddr3_ctrl_amm_0_burst_adapter_source0_endofpacket),   //  output,    width = 1,          .endofpacket
		.source0_ready         (ddr3_ctrl_amm_0_burst_adapter_source0_ready)          //   input,    width = 1,          .ready
	);
