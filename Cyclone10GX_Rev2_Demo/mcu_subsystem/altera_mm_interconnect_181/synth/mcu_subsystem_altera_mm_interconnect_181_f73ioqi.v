// mcu_subsystem_altera_mm_interconnect_181_f73ioqi.v
...
`timescale 1 ps / 1 ps
module mcu_subsystem_altera_mm_interconnect_181_f73ioqi (
	...
	wire  [118:0] rsp_mux_src_data;                                               // rsp_mux:src_data -> bridge_0_m0_agent:rp_data
	...
	wire  [118:0] bridge_0_m0_agent_cp_data;                                      // bridge_0_m0_agent:cp_data -> router:sink_data
	...
	wire  [118:0] cmd_mux_src_data;                                               // cmd_mux:src_data -> ddr3_ctrl_amm_0_cmd_width_adapter:in_data
	...
	wire  [118:0] ddr3_ctrl_amm_0_rsp_width_adapter_src_data;                     // ddr3_ctrl_amm_0_rsp_width_adapter:out_data -> rsp_demux:sink_data
	...
	mcu_subsystem_altera_merlin_master_agent_181_t5eyqrq #(
		...
		.cp_data               (bridge_0_m0_agent_cp_data),                                      //  output,  width = 119,          .data
		...
		.rp_data               (rsp_mux_src_data),                                               //   input,  width = 119,          .data
	...
	mcu_subsystem_altera_merlin_demultiplexer_181_zsesnpq cmd_demux (
		.clk                (ddr3_emif_usr_clk_clk),                         //   input,    width = 1,       clk.clk
		.reset              (bridge_0_m0_reset_reset_bridge_in_reset_reset), //   input,    width = 1, clk_reset.reset
		.sink_ready         (router_src_ready),                              //  output,    width = 1,      sink.ready
		.sink_channel       (router_src_channel),                            //   input,    width = 1,          .channel
		.sink_data          (router_src_data),                               //   input,  width = 119,          .data
	...
	mcu_subsystem_altera_merlin_multiplexer_181_ycgjzyi cmd_mux (
		.clk                 (ddr3_emif_usr_clk_clk),                         //   input,    width = 1,       clk.clk
		.reset               (bridge_0_m0_reset_reset_bridge_in_reset_reset), //   input,    width = 1, clk_reset.reset
	...
	mcu_subsystem_altera_merlin_demultiplexer_181_zsesnpq rsp_demux (
		.clk                (ddr3_emif_usr_clk_clk),                               //   input,    width = 1,       clk.clk
		.reset              (bridge_0_m0_reset_reset_bridge_in_reset_reset),       //   input,    width = 1, clk_reset.reset
		...
		.sink_data          (ddr3_ctrl_amm_0_rsp_width_adapter_src_data),          //   input,  width = 119,          .data
	...
	mcu_subsystem_altera_merlin_multiplexer_181_rp7lc2y rsp_mux (
		.clk                 (ddr3_emif_usr_clk_clk),                         //   input,    width = 1,       clk.clk
		.reset               (bridge_0_m0_reset_reset_bridge_in_reset_reset), //   input,    width = 1, clk_reset.reset
	...
	mcu_subsystem_altera_merlin_width_adapter_181_ndsdyta #(
		.IN_PKT_ADDR_H                 (66),
		.IN_PKT_ADDR_L                 (36),
		.IN_PKT_DATA_H                 (31),
		.IN_PKT_DATA_L                 (0),
		...
		.in_data              (cmd_mux_src_data),                                    //   input,  width = 119,          .data
	...
	mcu_subsystem_altera_merlin_width_adapter_181_yquwqma #(
		.IN_PKT_ADDR_H                 (318),
		.IN_PKT_ADDR_L                 (288),
		.IN_PKT_DATA_H                 (255),
		.IN_PKT_DATA_L                 (0),
		...
		.out_data             (ddr3_ctrl_amm_0_rsp_width_adapter_src_data),          //  output,  width = 119,          .data
