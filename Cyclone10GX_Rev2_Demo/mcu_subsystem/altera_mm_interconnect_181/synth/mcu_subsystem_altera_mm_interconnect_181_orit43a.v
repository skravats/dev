// mcu_subsystem_altera_mm_interconnect_181_orit43a.v
...
`timescale 1 ps / 1 ps
module mcu_subsystem_altera_mm_interconnect_181_orit43a (
	...
	wire          qspi_controller2_0_avl_mem_agent_rdata_fifo_src_valid;          // qspi_controller2_0_avl_mem_agent:rdata_fifo_src_valid -> qspi_controller2_0_avl_mem_agent:rdata_fifo_sink_valid
	wire   [33:0] qspi_controller2_0_avl_mem_agent_rdata_fifo_src_data;           // qspi_controller2_0_avl_mem_agent:rdata_fifo_src_data -> qspi_controller2_0_avl_mem_agent:rdata_fifo_sink_data
	wire          qspi_controller2_0_avl_mem_agent_rdata_fifo_src_ready;          // qspi_controller2_0_avl_mem_agent:rdata_fifo_sink_ready -> qspi_controller2_0_avl_mem_agent:rdata_fifo_src_ready
	...
	mcu_subsystem_altera_merlin_slave_agent_181_a7g37xa #(
		...
		.rdata_fifo_sink_ready   (qspi_controller2_0_avl_mem_agent_rdata_fifo_src_ready),       //  output,    width = 1, rdata_fifo_sink.ready
		.rdata_fifo_sink_valid   (qspi_controller2_0_avl_mem_agent_rdata_fifo_src_valid),       //   input,    width = 1,                .valid
		.rdata_fifo_sink_data    (qspi_controller2_0_avl_mem_agent_rdata_fifo_src_data),        //   input,   width = 34,                .data
