...
module mcu_subsystem_altera_merlin_router_181_vvnlfrq_default_decode
  #(
...
module mcu_subsystem_altera_merlin_router_181_vvnlfrq
(
    // -------------------
    // Clock & Reset
    // -------------------
    ...
    localparam PAD3 = log2ceil(64'h8806b000 - 64'h8806a000); 
    localparam PAD4 = log2ceil(64'h88079000 - 64'h88078800); 
    // -------------------------------------------------------
    // Work out which address bits are significant based on the
    // address range of the slaves. If the required width is too
    // large or too small, we use the address field width instead.
    // -------------------------------------------------------
    localparam ADDR_RANGE = 64'h88079000;
    ...
    mcu_subsystem_altera_merlin_router_181_vvnlfrq_default_decode the_default_decode(
    ...
    if ( {address[RG:PAD3],{PAD3{1'b0}}} == 32'h8806a000   ) begin
            src_channel = 40'b01000;
            src_data[PKT_DEST_ID_H:PKT_DEST_ID_L] = 20;
    end

    // ( 0x88078800 .. 0x88079000 )
    if ( {address[RG:PAD4],{PAD4{1'b0}}} == 32'h88078800   ) begin
