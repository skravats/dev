...
module mcu_subsystem_altera_merlin_router_181_av4knyi_default_decode
  #(
...
module mcu_subsystem_altera_merlin_router_181_av4knyi
(
    // -------------------
    // Clock & Reset
    // -------------------
    ...
    localparam PAD16 = log2ceil(64'h88076000 - 64'h88075000); 
    localparam PAD17 = log2ceil(64'h88077000 - 64'h88076000); 
    localparam PAD18 = log2ceil(64'h88078000 - 64'h88077000); 
    localparam PAD19 = log2ceil(64'h88078000 - 64'h88077000); 
    localparam PAD20 = log2ceil(64'h88079000 - 64'h88078000); 
    localparam PAD21 = log2ceil(64'h88079000 - 64'h88078000); 
    localparam PAD22 = log2ceil(64'h8807a000 - 64'h88079000); 
    localparam PAD23 = log2ceil(64'h8807b000 - 64'h8807a800); 
    localparam PAD24 = log2ceil(64'h8807b840 - 64'h8807b800); 
    localparam PAD25 = log2ceil(64'h8807b880 - 64'h8807b840); 
    localparam PAD26 = log2ceil(64'h8807b8a0 - 64'h8807b880); 
    localparam PAD27 = log2ceil(64'h8807b8c0 - 64'h8807b8a0); 
    localparam PAD28 = log2ceil(64'h8807b8e0 - 64'h8807b8c0); 
    localparam PAD29 = log2ceil(64'h8807b900 - 64'h8807b8e0); 
    localparam PAD30 = log2ceil(64'h8807b908 - 64'h8807b900); 
    localparam PAD31 = log2ceil(64'h90000400 - 64'h90000000); 
    // -------------------------------------------------------
    // Work out which address bits are significant based on the
    // address range of the slaves. If the required width is too
    // large or too small, we use the address field width instead.
    // -------------------------------------------------------
    localparam ADDR_RANGE = 64'h90000400;
    ...
    mcu_subsystem_altera_merlin_router_181_av4knyi_default_decode the_default_decode(
