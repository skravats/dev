...
module mcu_subsystem_altera_merlin_router_181_5un6klq_default_decode
  #(
...
module mcu_subsystem_altera_merlin_router_181_5un6klq
(
    // -------------------
    // Clock & Reset
    // -------------------
    ...
    localparam PAD17 = log2ceil(64'h8806f000 - 64'h8806e000); 
    localparam PAD18 = log2ceil(64'h88070000 - 64'h8806f000); 
    localparam PAD19 = log2ceil(64'h88071000 - 64'h88070000); 
    localparam PAD20 = log2ceil(64'h88072000 - 64'h88071000); 
    localparam PAD21 = log2ceil(64'h88073000 - 64'h88072000); 
    ...
    mcu_subsystem_altera_merlin_router_181_5un6klq_default_decode the_default_decode(
    ...
    if ( {address[RG:PAD17],{PAD17{1'b0}}} == 32'h8806e000   ) begin
    ...
    if ( {address[RG:PAD19],{PAD19{1'b0}}} == 32'h88070000   ) begin
    ...
    if ( {address[RG:PAD21],{PAD21{1'b0}}} == 32'h88072000   ) begin
