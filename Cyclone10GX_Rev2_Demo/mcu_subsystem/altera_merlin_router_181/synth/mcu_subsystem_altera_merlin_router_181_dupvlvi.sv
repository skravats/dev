...
module mcu_subsystem_altera_merlin_router_181_dupvlvi_default_decode
  #(
...
module mcu_subsystem_altera_merlin_router_181_dupvlvi
(
    // -------------------
    // Clock & Reset
    // -------------------
    ...
    localparam PAD4 = log2ceil(64'h88073000 - 64'h88072800); 
    // -------------------------------------------------------
    // Work out which address bits are significant based on the
    // address range of the slaves. If the required width is too
    // large or too small, we use the address field width instead.
    // -------------------------------------------------------
    localparam ADDR_RANGE = 64'h88073000;
    ...
    mcu_subsystem_altera_merlin_router_181_dupvlvi_default_decode the_default_decode(
    ...
    if ( {address[RG:PAD4],{PAD4{1'b0}}} == 32'h88072800   ) begin
