...
module mcu_subsystem_altera_merlin_router_181_vnfvlxq_default_decode
  #(
     parameter DEFAULT_CHANNEL = 33,
...
module mcu_subsystem_altera_merlin_router_181_vnfvlxq
(
    // -------------------
    // Clock & Reset
    // -------------------
    ...
    localparam PAD11 = log2ceil(64'h8806b000 - 64'h8806a000); 
    localparam PAD12 = log2ceil(64'h8806b000 - 64'h8806a000); 
    localparam PAD13 = log2ceil(64'h8806c000 - 64'h8806b000); 
    localparam PAD14 = log2ceil(64'h8806c000 - 64'h8806b000); 
    localparam PAD15 = log2ceil(64'h8806d000 - 64'h8806c000); 
    localparam PAD16 = log2ceil(64'h8806e000 - 64'h8806d000); 
    localparam PAD17 = log2ceil(64'h8806e004 - 64'h8806e000); 
    localparam PAD18 = log2ceil(64'h88070000 - 64'h8806f000); 
    localparam PAD19 = log2ceil(64'h88070004 - 64'h88070000); 
    localparam PAD20 = log2ceil(64'h88072000 - 64'h88071000); 
    localparam PAD21 = log2ceil(64'h88072004 - 64'h88072000); 
    localparam PAD22 = log2ceil(64'h88074000 - 64'h88073000); 
    localparam PAD23 = log2ceil(64'h88074004 - 64'h88074000); 
    localparam PAD24 = log2ceil(64'h88076000 - 64'h88075000); 
    localparam PAD25 = log2ceil(64'h88077000 - 64'h88076000); 
    localparam PAD26 = log2ceil(64'h88078000 - 64'h88077000); 
    localparam PAD27 = log2ceil(64'h88078000 - 64'h88077000); 
    localparam PAD28 = log2ceil(64'h88079000 - 64'h88078000); 
    localparam PAD29 = log2ceil(64'h88079000 - 64'h88078000); 
    localparam PAD30 = log2ceil(64'h8807a000 - 64'h88079000); 
    localparam PAD31 = log2ceil(64'h8807b000 - 64'h8807a800); 
    localparam PAD32 = log2ceil(64'h8807b840 - 64'h8807b800); 
    localparam PAD33 = log2ceil(64'h8807b880 - 64'h8807b840); 
    localparam PAD34 = log2ceil(64'h8807b8a0 - 64'h8807b880); 
    localparam PAD35 = log2ceil(64'h8807b8c0 - 64'h8807b8a0); 
    localparam PAD36 = log2ceil(64'h8807b8e0 - 64'h8807b8c0); 
    localparam PAD37 = log2ceil(64'h8807b900 - 64'h8807b8e0); 
    localparam PAD38 = log2ceil(64'h8807b908 - 64'h8807b900); 
    // -------------------------------------------------------
    // Work out which address bits are significant based on the
    // address range of the slaves. If the required width is too
    // large or too small, we use the address field width instead.
    // -------------------------------------------------------
    localparam ADDR_RANGE = 64'h8807b908;
    ...
    mcu_subsystem_altera_merlin_router_181_vnfvlxq_default_decode the_default_decode(
    ...
    if ( {address[RG:PAD11],{PAD11{1'b0}}} == 32'h8806a000  && write_transaction  ) begin
            src_channel = 39'b000000000000000000000000001000000000000;
            src_data[PKT_DEST_ID_H:PKT_DEST_ID_L] = 11;
    end

    // ( 0x8806a000 .. 0x8806b000 )
    if ( {address[RG:PAD12],{PAD12{1'b0}}} == 32'h8806a000  && read_transaction  ) begin
            src_channel = 39'b000000000000000000000000010000000000000;
            src_data[PKT_DEST_ID_H:PKT_DEST_ID_L] = 11;
    end

    // ( 0x8806b000 .. 0x8806c000 )
    if ( {address[RG:PAD13],{PAD13{1'b0}}} == 32'h8806b000  && write_transaction  ) begin
            src_channel = 39'b000000000000000000000000000010000000000;
            src_data[PKT_DEST_ID_H:PKT_DEST_ID_L] = 1;
    end

    // ( 0x8806b000 .. 0x8806c000 )
    if ( {address[RG:PAD14],{PAD14{1'b0}}} == 32'h8806b000  && read_transaction  ) begin
            src_channel = 39'b000000000000000000000000000100000000000;
            src_data[PKT_DEST_ID_H:PKT_DEST_ID_L] = 1;
    end

    // ( 0x8806c000 .. 0x8806d000 )
    if ( {address[RG:PAD15],{PAD15{1'b0}}} == 32'h8806c000   ) begin
            src_channel = 39'b000000100000000000000000000000000000000;
            src_data[PKT_DEST_ID_H:PKT_DEST_ID_L] = 20;
    end

    // ( 0x8806d000 .. 0x8806e000 )
    if ( {address[RG:PAD16],{PAD16{1'b0}}} == 32'h8806d000   ) begin
            src_channel = 39'b000000000100000000000000000000000000000;
            src_data[PKT_DEST_ID_H:PKT_DEST_ID_L] = 18;
    end

    // ( 0x8806e000 .. 0x8806e004 )
    if ( {address[RG:PAD17],{PAD17{1'b0}}} == 32'h8806e000  && read_transaction  ) begin
            src_channel = 39'b000000000010000000000000000000000000000;
            src_data[PKT_DEST_ID_H:PKT_DEST_ID_L] = 9;
    end

    // ( 0x8806f000 .. 0x88070000 )
    if ( {address[RG:PAD18],{PAD18{1'b0}}} == 32'h8806f000   ) begin
            src_channel = 39'b000000000001000000000000000000000000000;
            src_data[PKT_DEST_ID_H:PKT_DEST_ID_L] = 17;
    end

    // ( 0x88070000 .. 0x88070004 )
    if ( {address[RG:PAD19],{PAD19{1'b0}}} == 32'h88070000  && read_transaction  ) begin
            src_channel = 39'b000000000000100000000000000000000000000;
            src_data[PKT_DEST_ID_H:PKT_DEST_ID_L] = 8;
    end

    // ( 0x88071000 .. 0x88072000 )
    if ( {address[RG:PAD20],{PAD20{1'b0}}} == 32'h88071000   ) begin
            src_channel = 39'b000000000000010000000000000000000000000;
            src_data[PKT_DEST_ID_H:PKT_DEST_ID_L] = 16;
    end

    // ( 0x88072000 .. 0x88072004 )
    if ( {address[RG:PAD21],{PAD21{1'b0}}} == 32'h88072000  && read_transaction  ) begin
            src_channel = 39'b000000000000001000000000000000000000000;
            src_data[PKT_DEST_ID_H:PKT_DEST_ID_L] = 7;
    end

    // ( 0x88073000 .. 0x88074000 )
    if ( {address[RG:PAD22],{PAD22{1'b0}}} == 32'h88073000   ) begin
            src_channel = 39'b000000000000000100000000000000000000000;
            src_data[PKT_DEST_ID_H:PKT_DEST_ID_L] = 15;
    end

    // ( 0x88074000 .. 0x88074004 )
    if ( {address[RG:PAD23],{PAD23{1'b0}}} == 32'h88074000  && read_transaction  ) begin
            src_channel = 39'b000000000000000010000000000000000000000;
            src_data[PKT_DEST_ID_H:PKT_DEST_ID_L] = 6;
    end

    // ( 0x88075000 .. 0x88076000 )
    if ( {address[RG:PAD24],{PAD24{1'b0}}} == 32'h88075000   ) begin
            src_channel = 39'b000000000000000001000000000000000000000;
            src_data[PKT_DEST_ID_H:PKT_DEST_ID_L] = 14;
    end

    // ( 0x88076000 .. 0x88077000 )
    if ( {address[RG:PAD25],{PAD25{1'b0}}} == 32'h88076000   ) begin
            src_channel = 39'b000000000000000000100000000000000000000;
            src_data[PKT_DEST_ID_H:PKT_DEST_ID_L] = 5;
    end

    // ( 0x88077000 .. 0x88078000 )
    if ( {address[RG:PAD26],{PAD26{1'b0}}} == 32'h88077000  && write_transaction  ) begin
            src_channel = 39'b000000000000000000000000000000000000100;
            src_data[PKT_DEST_ID_H:PKT_DEST_ID_L] = 12;
    end

    // ( 0x88077000 .. 0x88078000 )
    if ( {address[RG:PAD27],{PAD27{1'b0}}} == 32'h88077000  && read_transaction  ) begin
            src_channel = 39'b000000000000000000000000000000000001000;
            src_data[PKT_DEST_ID_H:PKT_DEST_ID_L] = 12;
    end

    // ( 0x88078000 .. 0x88079000 )
    if ( {address[RG:PAD28],{PAD28{1'b0}}} == 32'h88078000  && write_transaction  ) begin
            src_channel = 39'b000000000000000000000000000000000000001;
            src_data[PKT_DEST_ID_H:PKT_DEST_ID_L] = 2;
    end

    // ( 0x88078000 .. 0x88079000 )
    if ( {address[RG:PAD29],{PAD29{1'b0}}} == 32'h88078000  && read_transaction  ) begin
            src_channel = 39'b000000000000000000000000000000000000010;
            src_data[PKT_DEST_ID_H:PKT_DEST_ID_L] = 2;
    end

    // ( 0x88079000 .. 0x8807a000 )
    if ( {address[RG:PAD30],{PAD30{1'b0}}} == 32'h88079000   ) begin
            src_channel = 39'b000000000000000000010000000000000000000;
            src_data[PKT_DEST_ID_H:PKT_DEST_ID_L] = 4;
    end

    // ( 0x8807a800 .. 0x8807b000 )
    if ( {address[RG:PAD31],{PAD31{1'b0}}} == 32'h8807a800   ) begin
            src_channel = 39'b000000000000000000001000000000000000000;
            src_data[PKT_DEST_ID_H:PKT_DEST_ID_L] = 26;
    end

    // ( 0x8807b800 .. 0x8807b840 )
    if ( {address[RG:PAD32],{PAD32{1'b0}}} == 32'h8807b800   ) begin
            src_channel = 39'b000000010000000000000000000000000000000;
            src_data[PKT_DEST_ID_H:PKT_DEST_ID_L] = 21;
    end

    // ( 0x8807b840 .. 0x8807b880 )
    if ( {address[RG:PAD33],{PAD33{1'b0}}} == 32'h8807b840   ) begin
            src_channel = 39'b000000000000000000000100000000000000000;
            src_data[PKT_DEST_ID_H:PKT_DEST_ID_L] = 24;
    end

    // ( 0x8807b880 .. 0x8807b8a0 )
    if ( {address[RG:PAD34],{PAD34{1'b0}}} == 32'h8807b880   ) begin
            src_channel = 39'b100000000000000000000000000000000000000;
            src_data[PKT_DEST_ID_H:PKT_DEST_ID_L] = 28;
    end

    // ( 0x8807b8a0 .. 0x8807b8c0 )
    if ( {address[RG:PAD35],{PAD35{1'b0}}} == 32'h8807b8a0   ) begin
            src_channel = 39'b010000000000000000000000000000000000000;
            src_data[PKT_DEST_ID_H:PKT_DEST_ID_L] = 23;
    end

    // ( 0x8807b8c0 .. 0x8807b8e0 )
    if ( {address[RG:PAD36],{PAD36{1'b0}}} == 32'h8807b8c0   ) begin
            src_channel = 39'b001000000000000000000000000000000000000;
            src_data[PKT_DEST_ID_H:PKT_DEST_ID_L] = 29;
    end

    // ( 0x8807b8e0 .. 0x8807b900 )
    if ( {address[RG:PAD37],{PAD37{1'b0}}} == 32'h8807b8e0   ) begin
            src_channel = 39'b000100000000000000000000000000000000000;
            src_data[PKT_DEST_ID_H:PKT_DEST_ID_L] = 30;
    end

    // ( 0x8807b900 .. 0x8807b908 )
    if ( {address[RG:PAD38],{PAD38{1'b0}}} == 32'h8807b900   ) begin
