...
module mcu_subsystem_altera_merlin_router_181_aft6nea_default_decode
  #(
  ...
  (output [118 - 114 : 0] default_destination_id,
...
module mcu_subsystem_altera_merlin_router_181_aft6nea
(
    // -------------------
    // Clock & Reset
    // -------------------
    ...
    localparam PAD35 = log2ceil(64'h880798c0 - 64'h88079880); 
    localparam PAD36 = log2ceil(64'h88079900 - 64'h880798c0); 
    localparam PAD37 = log2ceil(64'h88079920 - 64'h88079900); 
    localparam PAD38 = log2ceil(64'h88079940 - 64'h88079920); 
    localparam PAD39 = log2ceil(64'h88079948 - 64'h88079940); 
    // -------------------------------------------------------
    // Work out which address bits are significant based on the
    // address range of the slaves. If the required width is too
    // large or too small, we use the address field width instead.
    // -------------------------------------------------------
    localparam ADDR_RANGE = 64'h88079948;
    ...
    mcu_subsystem_altera_merlin_router_181_aft6nea_default_decode the_default_decode(
    ...
    // ( 0x88079880 .. 0x880798c0 )
    if ( {address[RG:PAD35],{PAD35{1'b0}}} == 32'h88079880   ) begin
            src_channel = 40'b0000100000000000000000000000000000000000;
            src_data[PKT_DEST_ID_H:PKT_DEST_ID_L] = 21;
    end

    // ( 0x880798c0 .. 0x88079900 )
    if ( {address[RG:PAD36],{PAD36{1'b0}}} == 32'h880798c0   ) begin
            src_channel = 40'b0000000000000000100000000000000000000000;
            src_data[PKT_DEST_ID_H:PKT_DEST_ID_L] = 25;
    end

    // ( 0x88079900 .. 0x88079920 )
    if ( {address[RG:PAD37],{PAD37{1'b0}}} == 32'h88079900   ) begin
            src_channel = 40'b1000000000000000000000000000000000000000;
            src_data[PKT_DEST_ID_H:PKT_DEST_ID_L] = 29;
    end

    // ( 0x88079920 .. 0x88079940 )
    if ( {address[RG:PAD38],{PAD38{1'b0}}} == 32'h88079920   ) begin
            src_channel = 40'b0100000000000000000000000000000000000000;
            src_data[PKT_DEST_ID_H:PKT_DEST_ID_L] = 24;
    end

    // ( 0x88079940 .. 0x88079948 )
    if ( {address[RG:PAD39],{PAD39{1'b0}}} == 32'h88079940   ) begin
