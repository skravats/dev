...
module mcu_subsystem_altera_merlin_router_181_dbtytqq_default_decode
  #(
...
module mcu_subsystem_altera_merlin_router_181_dbtytqq
(
    // -------------------
    // Clock & Reset
    // -------------------
    ...
    mcu_subsystem_altera_merlin_router_181_dbtytqq_default_decode the_default_decode(
