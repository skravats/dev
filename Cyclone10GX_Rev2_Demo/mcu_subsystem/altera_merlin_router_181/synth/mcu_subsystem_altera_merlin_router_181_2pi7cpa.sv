...
module mcu_subsystem_altera_merlin_router_181_2pi7cpa_default_decode
  #(
...
module mcu_subsystem_altera_merlin_router_181_2pi7cpa
(
    // -------------------
    // Clock & Reset
    // -------------------
    ...
    mcu_subsystem_altera_merlin_router_181_2pi7cpa_default_decode the_default_decode(
