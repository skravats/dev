...
module mcu_subsystem_altera_merlin_router_181_yhezy4i_default_decode
  #(
...
module mcu_subsystem_altera_merlin_router_181_yhezy4i
(
    // -------------------
    // Clock & Reset
    // -------------------
    ...
    localparam PAD18 = log2ceil(64'h8806f000 - 64'h8806e000); 
    localparam PAD19 = log2ceil(64'h88070000 - 64'h8806f000); 
    ...
    localparam PAD32 = log2ceil(64'h88079040 - 64'h88079000); 
    localparam PAD33 = log2ceil(64'h88079080 - 64'h88079040); 
    localparam PAD34 = log2ceil(64'h880790a0 - 64'h88079080); 
    localparam PAD35 = log2ceil(64'h880790c0 - 64'h880790a0); 
    localparam PAD36 = log2ceil(64'h880790e0 - 64'h880790c0); 
    localparam PAD37 = log2ceil(64'h88079100 - 64'h880790e0); 
    localparam PAD38 = log2ceil(64'h88079108 - 64'h88079100); 
    // -------------------------------------------------------
    // Work out which address bits are significant based on the
    // address range of the slaves. If the required width is too
    // large or too small, we use the address field width instead.
    // -------------------------------------------------------
    localparam ADDR_RANGE = 64'h88079108;
    ...
    mcu_subsystem_altera_merlin_router_181_yhezy4i_default_decode the_default_decode(
    ...
    if ( {address[RG:PAD13],{PAD13{1'b0}}} == 32'h8806a000   ) begin
            src_channel = 39'b000000000010000000000000000000000000000;
            src_data[PKT_DEST_ID_H:PKT_DEST_ID_L] = 16;
    end

    // ( 0x8806b000 .. 0x8806c000 )
    if ( {address[RG:PAD14],{PAD14{1'b0}}} == 32'h8806b000   ) begin
    ...
    if ( {address[RG:PAD17],{PAD17{1'b0}}} == 32'h8806e000  && write_transaction  ) begin
            src_channel = 39'b000000000000000000000000001000000000000;
            src_data[PKT_DEST_ID_H:PKT_DEST_ID_L] = 7;
    end

    // ( 0x8806e000 .. 0x8806f000 )
    if ( {address[RG:PAD18],{PAD18{1'b0}}} == 32'h8806e000  && read_transaction  ) begin
            src_channel = 39'b000000000000000000000000010000000000000;
            src_data[PKT_DEST_ID_H:PKT_DEST_ID_L] = 7;
    end

    // ( 0x8806f000 .. 0x88070000 )
    if ( {address[RG:PAD19],{PAD19{1'b0}}} == 32'h8806f000  && write_transaction  ) begin
            src_channel = 39'b000000000000000000000000000010000000000;
            src_data[PKT_DEST_ID_H:PKT_DEST_ID_L] = 1;
    end

    // ( 0x8806f000 .. 0x88070000 )
    if ( {address[RG:PAD20],{PAD20{1'b0}}} == 32'h8806f000  && read_transaction  ) begin
    ...
    // ( 0x88079000 .. 0x88079040 )
    if ( {address[RG:PAD32],{PAD32{1'b0}}} == 32'h88079000   ) begin
            src_channel = 39'b000000010000000000000000000000000000000;
            src_data[PKT_DEST_ID_H:PKT_DEST_ID_L] = 21;
    end

    // ( 0x88079040 .. 0x88079080 )
    if ( {address[RG:PAD33],{PAD33{1'b0}}} == 32'h88079040   ) begin
            src_channel = 39'b000000000000000000000100000000000000000;
            src_data[PKT_DEST_ID_H:PKT_DEST_ID_L] = 24;
    end

    // ( 0x88079080 .. 0x880790a0 )
    if ( {address[RG:PAD34],{PAD34{1'b0}}} == 32'h88079080   ) begin
            src_channel = 39'b100000000000000000000000000000000000000;
            src_data[PKT_DEST_ID_H:PKT_DEST_ID_L] = 28;
    end

    // ( 0x880790a0 .. 0x880790c0 )
    if ( {address[RG:PAD35],{PAD35{1'b0}}} == 32'h880790a0   ) begin
            src_channel = 39'b010000000000000000000000000000000000000;
            src_data[PKT_DEST_ID_H:PKT_DEST_ID_L] = 23;
    end

    // ( 0x880790c0 .. 0x880790e0 )
    if ( {address[RG:PAD36],{PAD36{1'b0}}} == 32'h880790c0   ) begin
            src_channel = 39'b001000000000000000000000000000000000000;
            src_data[PKT_DEST_ID_H:PKT_DEST_ID_L] = 29;
    end

    // ( 0x880790e0 .. 0x88079100 )
    if ( {address[RG:PAD37],{PAD37{1'b0}}} == 32'h880790e0   ) begin
            src_channel = 39'b000100000000000000000000000000000000000;
            src_data[PKT_DEST_ID_H:PKT_DEST_ID_L] = 30;
    end

    // ( 0x88079100 .. 0x88079108 )
    if ( {address[RG:PAD38],{PAD38{1'b0}}} == 32'h88079100   ) begin
