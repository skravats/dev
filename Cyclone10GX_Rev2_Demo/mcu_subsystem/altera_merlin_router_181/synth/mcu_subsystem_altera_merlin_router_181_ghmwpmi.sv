...
module mcu_subsystem_altera_merlin_router_181_ghmwpmi_default_decode
  #(
...
module mcu_subsystem_altera_merlin_router_181_ghmwpmi
(
    // -------------------
    // Clock & Reset
    // -------------------
    ...
    localparam PAD3 = log2ceil(64'h88071000 - 64'h88070000); 
    ...
    mcu_subsystem_altera_merlin_router_181_ghmwpmi_default_decode the_default_decode(
    ...
    if ( {address[RG:PAD3],{PAD3{1'b0}}} == 32'h88070000   ) begin
