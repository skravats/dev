...
module mcu_subsystem_altera_merlin_router_181_mkupsqy_default_decode
  #(
...
module mcu_subsystem_altera_merlin_router_181_mkupsqy
(
    // -------------------
    // Clock & Reset
    // -------------------
    ...
    localparam PAD3 = log2ceil(64'h8806d000 - 64'h8806c000); 
    localparam PAD4 = log2ceil(64'h8807b000 - 64'h8807a800); 
    // -------------------------------------------------------
    // Work out which address bits are significant based on the
    // address range of the slaves. If the required width is too
    // large or too small, we use the address field width instead.
    // -------------------------------------------------------
    localparam ADDR_RANGE = 64'h8807b000;
    ...
    mcu_subsystem_altera_merlin_router_181_mkupsqy_default_decode the_default_decode(
    ...
    if ( {address[RG:PAD3],{PAD3{1'b0}}} == 32'h8806c000   ) begin
            src_channel = 43'b00100;
            src_data[PKT_DEST_ID_H:PKT_DEST_ID_L] = 20;
    end

    // ( 0x8807a800 .. 0x8807b000 )
    if ( {address[RG:PAD4],{PAD4{1'b0}}} == 32'h8807a800   ) begin
