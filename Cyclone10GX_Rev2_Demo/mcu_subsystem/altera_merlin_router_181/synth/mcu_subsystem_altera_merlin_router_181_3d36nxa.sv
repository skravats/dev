...
module mcu_subsystem_altera_merlin_router_181_3d36nxa_default_decode
  #(
  ...
  (output [225 - 221 : 0] default_destination_id,
...
module mcu_subsystem_altera_merlin_router_181_3d36nxa
(
    // -------------------
    // Clock & Reset
    // -------------------
    ...
    mcu_subsystem_altera_merlin_router_181_3d36nxa_default_decode the_default_decode(
