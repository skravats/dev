...
module mcu_subsystem_altera_merlin_router_181_avfevya_default_decode
  #(
...
module mcu_subsystem_altera_merlin_router_181_avfevya
(
    // -------------------
    // Clock & Reset
    // -------------------
    ...
    mcu_subsystem_altera_merlin_router_181_avfevya_default_decode the_default_decode(
    ...
    always @* begin
        ...
        if (destid == 2 ) begin
            src_channel = 33'b000001;
        end

        if (destid == 3  && read_transaction) begin
            src_channel = 33'b000010;
        end

        if (destid == 1  && write_transaction) begin
            src_channel = 33'b000100;
        end

        if (destid == 1  && read_transaction) begin
            src_channel = 33'b001000;
        end

        if (destid == 0  && write_transaction) begin
            src_channel = 33'b010000;
        end

        if (destid == 0  && read_transaction) begin
            src_channel = 33'b100000;
        end
