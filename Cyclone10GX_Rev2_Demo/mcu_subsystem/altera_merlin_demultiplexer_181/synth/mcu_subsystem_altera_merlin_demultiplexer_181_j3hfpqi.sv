...
//   output_name:         mcu_subsystem_altera_merlin_demultiplexer_181_j3hfpqi
//   ST_DATA_W:           393
//   ST_CHANNEL_W:        40
//   NUM_OUTPUTS:         7
//   VALID_WIDTH:         1
...
module mcu_subsystem_altera_merlin_demultiplexer_181_j3hfpqi
(
    // -------------------
    // Sink
    // -------------------
    ...
    output reg [393-1    : 0] src2_data, // ST_DATA_W=393
    ...
    output reg [393-1    : 0] src3_data, // ST_DATA_W=393
    ...
    output reg [393-1    : 0] src4_data, // ST_DATA_W=393
    ...
    output reg [393-1    : 0] src5_data, // ST_DATA_W=393
    ...
    output reg [393-1    : 0] src6_data, // ST_DATA_W=393
