...
//   output_name:         mcu_subsystem_altera_merlin_demultiplexer_181_23ebplq
//   ST_DATA_W:           141
//   ST_CHANNEL_W:        40
//   NUM_OUTPUTS:         40
//   VALID_WIDTH:         40
...
module mcu_subsystem_altera_merlin_demultiplexer_181_23ebplq
(
    // -------------------
    // Sink
    // -------------------
    ...
    output reg [141-1    : 0] src6_data, // ST_DATA_W=141
    ...
    output reg [141-1    : 0] src7_data, // ST_DATA_W=141
    ...
    output reg [141-1    : 0] src8_data, // ST_DATA_W=141
    ...
    output reg [141-1    : 0] src9_data, // ST_DATA_W=141
    ...
    output reg [141-1    : 0] src10_data, // ST_DATA_W=141
    ...
    output reg [141-1    : 0] src11_data, // ST_DATA_W=141
    ...
    output reg [141-1    : 0] src12_data, // ST_DATA_W=141
    ...
    output reg [141-1    : 0] src13_data, // ST_DATA_W=141
    ...
    output reg [141-1    : 0] src14_data, // ST_DATA_W=141
    ...
    output reg [141-1    : 0] src15_data, // ST_DATA_W=141
    ...
    output reg [141-1    : 0] src16_data, // ST_DATA_W=141
    ...
    output reg [141-1    : 0] src17_data, // ST_DATA_W=141
    ...
    output reg [141-1    : 0] src18_data, // ST_DATA_W=141
    ...
    output reg [141-1    : 0] src19_data, // ST_DATA_W=141
    ...
    output reg [141-1    : 0] src20_data, // ST_DATA_W=141
    ...
    output reg [141-1    : 0] src21_data, // ST_DATA_W=141
    ...
    output reg [141-1    : 0] src22_data, // ST_DATA_W=141
    ...
    output reg [141-1    : 0] src23_data, // ST_DATA_W=141
    ...
    output reg [141-1    : 0] src24_data, // ST_DATA_W=141
    ...
    output reg [141-1    : 0] src25_data, // ST_DATA_W=141
    ...
    output reg [141-1    : 0] src26_data, // ST_DATA_W=141
    ...
    output reg [141-1    : 0] src27_data, // ST_DATA_W=141
    ...
    output reg [141-1    : 0] src28_data, // ST_DATA_W=141
    ...
    output reg [141-1    : 0] src29_data, // ST_DATA_W=141
    ...
    output reg [141-1    : 0] src30_data, // ST_DATA_W=141
    ...
    output reg [141-1    : 0] src31_data, // ST_DATA_W=141
    ...
    output reg [141-1    : 0] src32_data, // ST_DATA_W=141
    ...
    output reg [141-1    : 0] src33_data, // ST_DATA_W=141
    ...
    output reg [141-1    : 0] src34_data, // ST_DATA_W=141
    ...
    output reg [141-1    : 0] src35_data, // ST_DATA_W=141
    ...
    output reg [141-1    : 0] src36_data, // ST_DATA_W=141
    ...
    output reg [141-1    : 0] src37_data, // ST_DATA_W=141
    ...
    output reg [141-1    : 0] src38_data, // ST_DATA_W=141
    ...
    output reg [141-1    : 0] src39_data, // ST_DATA_W=141
