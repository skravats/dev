	ddr_controller u0 (
		...
		.mem_a                          (_connected_to_mem_a_),                          //  output,   width = 16,                 .mem_a
		...
		.mem_dm                         (_connected_to_mem_dm_),                         //  output,    width = 4,                 .mem_dm
		...
		.mmr_slave_waitrequest_0        (_connected_to_mmr_slave_waitrequest_0_),        //  output,    width = 1, ctrl_mmr_slave_0.waitrequest
		.mmr_slave_read_0               (_connected_to_mmr_slave_read_0_),               //   input,    width = 1,                 .read
		.mmr_slave_write_0              (_connected_to_mmr_slave_write_0_),              //   input,    width = 1,                 .write
		.mmr_slave_address_0            (_connected_to_mmr_slave_address_0_),            //   input,   width = 10,                 .address
		.mmr_slave_readdata_0           (_connected_to_mmr_slave_readdata_0_),           //  output,   width = 32,                 .readdata
		.mmr_slave_writedata_0          (_connected_to_mmr_slave_writedata_0_),          //   input,   width = 32,                 .writedata
		.mmr_slave_burstcount_0         (_connected_to_mmr_slave_burstcount_0_),         //   input,    width = 2,                 .burstcount
		.mmr_slave_beginbursttransfer_0 (_connected_to_mmr_slave_beginbursttransfer_0_), //   input,    width = 1,                 .beginbursttransfer
		.mmr_slave_readdatavalid_0      (_connected_to_mmr_slave_readdatavalid_0_)       //  output,    width = 1,                 .readdatavalid
	);
