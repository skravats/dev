module ddr_controller_altera_emif_arch_nf_181_ygvy23y #(
   ...
   output logic [255:0]    amm_readdata_0,
   input  logic [255:0]    amm_writedata_0,
   input  logic [6:0]      amm_burstcount_0,
   input  logic [31:0]     amm_byteenable_0,
   ...
   output logic [255:0]    amm_readdata_1,
   input  logic [255:0]    amm_writedata_1,
   input  logic [6:0]      amm_burstcount_1,
   input  logic [31:0]     amm_byteenable_1,
   ...
   ddr_controller_altera_emif_arch_nf_181_ygvy23y_top # (
      ...
      .SEQ_SYNTH_PARAMS_HEX_FILENAME ("ddr_controller_altera_emif_arch_nf_181_ygvy23y_seq_params_synth.hex"),
      .SEQ_SIM_PARAMS_HEX_FILENAME ("ddr_controller_altera_emif_arch_nf_181_ygvy23y_seq_params_sim.hex"),
      .SEQ_CODE_HEX_FILENAME ("ddr_controller_altera_emif_arch_nf_181_ygvy23y_seq_cal.hex")
   ) arch_inst (
