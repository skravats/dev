...
module ad9144_dma (
	...
	axi_dmac #(
		...
		.m_axis_valid           (m_axis_valid),                                                                                                                          //  output,    width = 1,    if_m_axis_valid.valid
		.m_axis_data            (m_axis_data),                                                                                                                           //  output,  width = 128,     if_m_axis_data.data
		.m_axis_ready           (m_axis_ready),                                                                                                                          //   input,    width = 1,    if_m_axis_ready.ready
		.m_axis_last            (m_axis_last),                                                                                                                           //  output,    width = 1,     if_m_axis_last.last
		...
		.m_src_axi_wdata        (m_src_axi_wdata),                                                                                                                       //  output,  width = 128,                   .wdata
		.m_src_axi_wstrb        (m_src_axi_wstrb),                                                                                                                       //  output,   width = 16,                   .wstrb
		...
		.m_src_axi_rdata        (m_src_axi_rdata),                                                                                                                       //   input,  width = 128,                   .rdata
		.m_src_axi_rready       (m_src_axi_rready),                                                                                                                      //  output,    width = 1,                   .rready
		.m_src_axi_awlen        (m_src_axi_awlen),                                                                                                                       //  output,    width = 8,                   .awlen
		...
		.m_src_axi_arlen        (m_src_axi_arlen),                                                                                                                       //  output,    width = 8,                   .arlen
