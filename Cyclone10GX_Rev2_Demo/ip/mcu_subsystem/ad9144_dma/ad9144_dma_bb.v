module ad9144_dma (
		...
		output wire         m_axis_valid,      //    if_m_axis_valid.valid
		output wire [127:0] m_axis_data,       //     if_m_axis_data.data
		input  wire         m_axis_ready,      //    if_m_axis_ready.ready
		output wire         m_axis_last,       //     if_m_axis_last.last
		...
		output wire [127:0] m_src_axi_wdata,   //                   .wdata
		output wire [15:0]  m_src_axi_wstrb,   //                   .wstrb
		...
		input  wire [127:0] m_src_axi_rdata,   //                   .rdata
		output wire         m_src_axi_rready,  //                   .rready
		output wire [7:0]   m_src_axi_awlen,   //                   .awlen
		...
		output wire [7:0]   m_src_axi_arlen,   //                   .arlen
