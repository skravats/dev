...
module ad9144_jesd204 (
	...
	ad9144_jesd204_adi_jesd204_10_kst36zy ad9144_jesd204 (
		...
		.pll_select_pll_select         (pll_select_pll_select),         //   input,    width = 1,        pll_select.pll_select
		...
		.lane_pll_reconfig_write       (lane_pll_reconfig_write),       //   input,    width = 1, lane_pll_reconfig.write
		.lane_pll_reconfig_read        (lane_pll_reconfig_read),        //   input,    width = 1,                  .read
		.lane_pll_reconfig_address     (lane_pll_reconfig_address),     //   input,   width = 10,                  .address
		.lane_pll_reconfig_writedata   (lane_pll_reconfig_writedata),   //   input,   width = 32,                  .writedata
		.lane_pll_reconfig_readdata    (lane_pll_reconfig_readdata),    //  output,   width = 32,                  .readdata
		.lane_pll_reconfig_waitrequest (lane_pll_reconfig_waitrequest), //  output,    width = 1,                  .waitrequest
		...
		.sync_export                   (sync_export),                   //   input,    width = 1,              sync.export
		.link_data_data                (link_data_data),                //   input,  width = 128,         link_data.data
		.link_data_ready               (link_data_ready),               //  output,    width = 1,                  .ready
		.link_data_valid               (link_data_valid)                //   input,    width = 1,                  .valid
	);
