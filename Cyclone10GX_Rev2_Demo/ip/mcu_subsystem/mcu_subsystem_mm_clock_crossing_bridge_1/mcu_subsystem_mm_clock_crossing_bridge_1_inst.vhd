	component mcu_subsystem_mm_clock_crossing_bridge_1 is
		generic (
	...
	end component mcu_subsystem_mm_clock_crossing_bridge_1;

	u0 : component mcu_subsystem_mm_clock_crossing_bridge_1
		generic map (
