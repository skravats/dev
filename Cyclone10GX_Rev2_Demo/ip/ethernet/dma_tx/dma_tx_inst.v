	dma_tx u0 (
		...
		.mm_read_byteenable           (_connected_to_mm_read_byteenable_),           //  output,   width = 32,                 .byteenable
		.mm_read_readdata             (_connected_to_mm_read_readdata_),             //   input,  width = 256,                 .readdata
		...
		.st_source_data               (_connected_to_st_source_data_),               //  output,  width = 256,        st_source.data
		...
		.st_source_empty              (_connected_to_st_source_empty_),              //  output,    width = 5,                 .empty
		.st_source_error              (_connected_to_st_source_error_),              //  output,    width = 8,                 .error
		.st_source_channel            (_connected_to_st_source_channel_)             //  output,    width = 8,                 .channel
	);
