	component dma_tx is
		port (
			...
			st_source_error              : out std_logic_vector(7 downto 0);                      -- error
			st_source_channel            : out std_logic_vector(7 downto 0)                       -- channel
		);
	end component dma_tx;
	...
	u0 : component dma_tx
		port map (
			...
			st_source_channel            => CONNECTED_TO_st_source_channel             --                 .channel
		);
