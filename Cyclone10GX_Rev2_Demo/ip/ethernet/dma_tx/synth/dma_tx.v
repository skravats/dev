...
module dma_tx (
	...
	dma_tx_altera_msgdma_181_kckrdxy dma_tx (
		...
		.mm_read_byteenable           (mm_read_byteenable),           //  output,   width = 32,                 .byteenable
		.mm_read_readdata             (mm_read_readdata),             //   input,  width = 256,                 .readdata
		...
		.st_source_data               (st_source_data),               //  output,  width = 256,        st_source.data
		...
		.st_source_empty              (st_source_empty),              //  output,    width = 5,                 .empty
		.st_source_error              (st_source_error),              //  output,    width = 8,                 .error
		.st_source_channel            (st_source_channel)             //  output,    width = 8,                 .channel
	);
