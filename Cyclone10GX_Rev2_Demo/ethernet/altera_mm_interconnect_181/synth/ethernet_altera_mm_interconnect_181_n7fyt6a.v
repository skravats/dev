// ethernet_altera_mm_interconnect_181_n7fyt6a.v
...
`timescale 1 ps / 1 ps
module ethernet_altera_mm_interconnect_181_n7fyt6a (
		...
		input  wire [255:0] dma_bridge_s0_readdata,                       //                                       .readdata
		output wire [255:0] dma_bridge_s0_writedata,                      //                                       .writedata
		output wire [7:0]   dma_bridge_s0_burstcount,                     //                                       .burstcount
		output wire [31:0]  dma_bridge_s0_byteenable,                     //                                       .byteenable
		...
		input  wire [1:0]   dma_bridge_s0_response,                       //                                       .response
	...
	wire  [255:0] dma_bridge_s0_agent_m0_readdata;                                    // dma_bridge_s0_translator:uav_readdata -> dma_bridge_s0_agent:m0_readdata
	...
	wire   [31:0] dma_bridge_s0_agent_m0_byteenable;                                  // dma_bridge_s0_agent:m0_byteenable -> dma_bridge_s0_translator:uav_byteenable
	...
	wire    [1:0] dma_bridge_s0_agent_m0_response;                                    // dma_bridge_s0_translator:uav_response -> dma_bridge_s0_agent:m0_response
	wire          dma_bridge_s0_agent_m0_lock;                                        // dma_bridge_s0_agent:m0_lock -> dma_bridge_s0_translator:uav_lock
	wire  [255:0] dma_bridge_s0_agent_m0_writedata;                                   // dma_bridge_s0_agent:m0_writedata -> dma_bridge_s0_translator:uav_writedata
	...
	wire  [376:0] dma_bridge_s0_agent_rf_source_data;                                 // dma_bridge_s0_agent:rf_source_data -> dma_bridge_s0_agent_rsp_fifo:in_data
	...
	wire  [376:0] dma_bridge_s0_agent_rsp_fifo_out_data;                              // dma_bridge_s0_agent_rsp_fifo:out_data -> dma_bridge_s0_agent:rf_sink_data
	...
	wire          dma_bridge_s0_agent_rdata_fifo_src_valid;                           // dma_bridge_s0_agent:rdata_fifo_src_valid -> dma_bridge_s0_agent:rdata_fifo_sink_valid
	wire  [257:0] dma_bridge_s0_agent_rdata_fifo_src_data;                            // dma_bridge_s0_agent:rdata_fifo_src_data -> dma_bridge_s0_agent:rdata_fifo_sink_data
	wire          dma_bridge_s0_agent_rdata_fifo_src_ready;                           // dma_bridge_s0_agent:rdata_fifo_sink_ready -> dma_bridge_s0_agent:rdata_fifo_src_ready
	...
	wire  [375:0] dma_bridge_s0_agent_rp_data;                                        // dma_bridge_s0_agent:rp_data -> router_002:sink_data
	...
	wire  [375:0] router_002_src_data;                                                // router_002:src_data -> rsp_demux:sink_data
	...
	wire          cmd_mux_src_valid;                                                  // cmd_mux:src_valid -> dma_bridge_s0_burst_adapter:sink0_valid
	wire  [375:0] cmd_mux_src_data;                                                   // cmd_mux:src_data -> dma_bridge_s0_burst_adapter:sink0_data
	wire          cmd_mux_src_ready;                                                  // dma_bridge_s0_burst_adapter:sink0_ready -> cmd_mux:src_ready
	wire    [1:0] cmd_mux_src_channel;                                                // cmd_mux:src_channel -> dma_bridge_s0_burst_adapter:sink0_channel
	wire          cmd_mux_src_startofpacket;                                          // cmd_mux:src_startofpacket -> dma_bridge_s0_burst_adapter:sink0_startofpacket
	wire          cmd_mux_src_endofpacket;                                            // cmd_mux:src_endofpacket -> dma_bridge_s0_burst_adapter:sink0_endofpacket
	wire          dma_bridge_s0_burst_adapter_source0_valid;                          // dma_bridge_s0_burst_adapter:source0_valid -> dma_bridge_s0_agent:cp_valid
	wire  [375:0] dma_bridge_s0_burst_adapter_source0_data;                           // dma_bridge_s0_burst_adapter:source0_data -> dma_bridge_s0_agent:cp_data
	...
	ethernet_altera_merlin_slave_translator_181_5aswt6a #(
		...
		.uav_byteenable         (dma_bridge_s0_agent_m0_byteenable),            //   input,   width = 32,                         .byteenable
		.uav_readdata           (dma_bridge_s0_agent_m0_readdata),              //  output,  width = 256,                         .readdata
		.uav_writedata          (dma_bridge_s0_agent_m0_writedata),             //   input,  width = 256,                         .writedata
		...
		.uav_response           (dma_bridge_s0_agent_m0_response),              //  output,    width = 2,                         .response
		...
		.av_readdata            (dma_bridge_s0_readdata),                       //   input,  width = 256,                         .readdata
		.av_writedata           (dma_bridge_s0_writedata),                      //  output,  width = 256,                         .writedata
		.av_burstcount          (dma_bridge_s0_burstcount),                     //  output,    width = 8,                         .burstcount
		.av_byteenable          (dma_bridge_s0_byteenable),                     //  output,   width = 32,                         .byteenable
		...
		.av_response            (dma_bridge_s0_response),                       //   input,    width = 2,                         .response
	...
	ethernet_altera_merlin_slave_agent_181_a7g37xa #(
		...
		.m0_byteenable           (dma_bridge_s0_agent_m0_byteenable),                 //  output,   width = 32,                .byteenable
		...
		.m0_readdata             (dma_bridge_s0_agent_m0_readdata),                   //   input,  width = 256,                .readdata
		...
		.m0_writedata            (dma_bridge_s0_agent_m0_writedata),                  //  output,  width = 256,                .writedata
		.m0_write                (dma_bridge_s0_agent_m0_write),                      //  output,    width = 1,                .write
		.m0_response             (dma_bridge_s0_agent_m0_response),                   //   input,    width = 2,                .response
		...
		.rp_data                 (dma_bridge_s0_agent_rp_data),                       //  output,  width = 376,                .data
		...
		.cp_data                 (dma_bridge_s0_burst_adapter_source0_data),          //   input,  width = 376,                .data
		...
		.rf_sink_data            (dma_bridge_s0_agent_rsp_fifo_out_data),             //   input,  width = 377,                .data
		...
		.rf_source_data          (dma_bridge_s0_agent_rf_source_data),                //  output,  width = 377,                .data
		.rdata_fifo_sink_ready   (dma_bridge_s0_agent_rdata_fifo_src_ready),          //  output,    width = 1, rdata_fifo_sink.ready
		.rdata_fifo_sink_valid   (dma_bridge_s0_agent_rdata_fifo_src_valid),          //   input,    width = 1,                .valid
		.rdata_fifo_sink_data    (dma_bridge_s0_agent_rdata_fifo_src_data),           //   input,  width = 258,                .data
		...
		.rdata_fifo_src_data     (dma_bridge_s0_agent_rdata_fifo_src_data),           //  output,  width = 258,                .data
	...
	ethernet_altera_avalon_sc_fifo_181_oywqgnq #(
		...
		.clk               (clock_out_clk_clk),                              //   input,    width = 1,       clk.clk
		.reset             (dma_bridge_reset_reset_bridge_in_reset_reset),   //   input,    width = 1, clk_reset.reset
		.in_data           (dma_bridge_s0_agent_rf_source_data),             //   input,  width = 377,        in.data
		...
		.out_data          (dma_bridge_s0_agent_rsp_fifo_out_data),          //  output,  width = 377,       out.data
	...
	ethernet_altera_merlin_router_181_lxq7bcy router_002 (
		...
		.sink_data          (dma_bridge_s0_agent_rp_data),                  //   input,  width = 376,          .data
		...
		.src_data           (router_002_src_data),                          //  output,  width = 376,          .data
		.src_channel        (router_002_src_channel),                       //  output,    width = 2,          .channel
		.src_startofpacket  (router_002_src_startofpacket),                 //  output,    width = 1,          .startofpacket
		.src_endofpacket    (router_002_src_endofpacket)                    //  output,    width = 1,          .endofpacket
	);

	ethernet_altera_merlin_burst_adapter_181_wo6j46a #(
		.PKT_ADDR_H                (319),
		.PKT_ADDR_L                (288),
		.PKT_BEGIN_BURST           (350),
		.PKT_BYTE_CNT_H            (341),
		...
		.sink0_data            (cmd_mux_src_data),                                  //   input,  width = 376,          .data
		...
		.source0_data          (dma_bridge_s0_burst_adapter_source0_data),          //  output,  width = 376,          .data
	...
	ethernet_altera_merlin_demultiplexer_181_2vo2s3a rsp_demux (
		...
		.sink_data          (router_002_src_data),                          //   input,  width = 376,          .data
