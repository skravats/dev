// ethernet_altera_mm_interconnect_181_koljzha.v
...
`timescale 1 ps / 1 ps
module ethernet_altera_mm_interconnect_181_koljzha (
		...
		input  wire [31:0]  mem_bridge_m0_byteenable,                     //                                       .byteenable
		input  wire         mem_bridge_m0_read,                           //                                       .read
		output wire [255:0] mem_bridge_m0_readdata,                       //                                       .readdata
		output wire         mem_bridge_m0_readdatavalid,                  //                                       .readdatavalid
		input  wire         mem_bridge_m0_write,                          //                                       .write
		input  wire [255:0] mem_bridge_m0_writedata,                      //                                       .writedata
	...
	wire  [255:0] mem_bridge_m0_translator_avalon_universal_master_0_readdata;      // mem_bridge_m0_agent:av_readdata -> mem_bridge_m0_translator:uav_readdata
	...
	wire   [31:0] mem_bridge_m0_translator_avalon_universal_master_0_byteenable;    // mem_bridge_m0_translator:uav_byteenable -> mem_bridge_m0_agent:av_byteenable
	...
	wire  [255:0] mem_bridge_m0_translator_avalon_universal_master_0_writedata;     // mem_bridge_m0_translator:uav_writedata -> mem_bridge_m0_agent:av_writedata
	wire    [5:0] mem_bridge_m0_translator_avalon_universal_master_0_burstcount;    // mem_bridge_m0_translator:uav_burstcount -> mem_bridge_m0_agent:av_burstcount
	...
	wire   [97:0] mac_control_port_agent_rf_source_data;                            // mac_control_port_agent:rf_source_data -> mac_control_port_agent_rsp_fifo:in_data
	...
	wire   [97:0] mac_control_port_agent_rsp_fifo_out_data;                         // mac_control_port_agent_rsp_fifo:out_data -> mac_control_port_agent:rf_sink_data
	...
	wire   [97:0] dma_rx_csr_agent_rf_source_data;                                  // dma_rx_csr_agent:rf_source_data -> dma_rx_csr_agent_rsp_fifo:in_data
	...
	wire   [97:0] dma_rx_csr_agent_rsp_fifo_out_data;                               // dma_rx_csr_agent_rsp_fifo:out_data -> dma_rx_csr_agent:rf_sink_data
	...
	wire   [97:0] dma_tx_csr_agent_rf_source_data;                                  // dma_tx_csr_agent:rf_source_data -> dma_tx_csr_agent_rsp_fifo:in_data
	...
	wire   [97:0] dma_tx_csr_agent_rsp_fifo_out_data;                               // dma_tx_csr_agent_rsp_fifo:out_data -> dma_tx_csr_agent:rf_sink_data
	...
	wire  [349:0] dma_rx_descriptor_slave_agent_rf_source_data;                     // dma_rx_descriptor_slave_agent:rf_source_data -> dma_rx_descriptor_slave_agent_rsp_fifo:in_data
	...
	wire  [349:0] dma_rx_descriptor_slave_agent_rsp_fifo_out_data;                  // dma_rx_descriptor_slave_agent_rsp_fifo:out_data -> dma_rx_descriptor_slave_agent:rf_sink_data
	...
	wire          dma_rx_descriptor_slave_agent_rdata_fifo_src_valid;               // dma_rx_descriptor_slave_agent:rdata_fifo_src_valid -> dma_rx_descriptor_slave_agent:rdata_fifo_sink_valid
	wire  [257:0] dma_rx_descriptor_slave_agent_rdata_fifo_src_data;                // dma_rx_descriptor_slave_agent:rdata_fifo_src_data -> dma_rx_descriptor_slave_agent:rdata_fifo_sink_data
	wire          dma_rx_descriptor_slave_agent_rdata_fifo_src_ready;               // dma_rx_descriptor_slave_agent:rdata_fifo_sink_ready -> dma_rx_descriptor_slave_agent:rdata_fifo_src_ready
	wire          cmd_mux_003_src_valid;                                            // cmd_mux_003:src_valid -> dma_rx_descriptor_slave_agent:cp_valid
	wire  [348:0] cmd_mux_003_src_data;                                             // cmd_mux_003:src_data -> dma_rx_descriptor_slave_agent:cp_data
	wire          cmd_mux_003_src_ready;                                            // dma_rx_descriptor_slave_agent:cp_ready -> cmd_mux_003:src_ready
	wire    [5:0] cmd_mux_003_src_channel;                                          // cmd_mux_003:src_channel -> dma_rx_descriptor_slave_agent:cp_channel
	wire          cmd_mux_003_src_startofpacket;                                    // cmd_mux_003:src_startofpacket -> dma_rx_descriptor_slave_agent:cp_startofpacket
	wire          cmd_mux_003_src_endofpacket;                                      // cmd_mux_003:src_endofpacket -> dma_rx_descriptor_slave_agent:cp_endofpacket
	...
	wire  [349:0] dma_tx_descriptor_slave_agent_rf_source_data;                     // dma_tx_descriptor_slave_agent:rf_source_data -> dma_tx_descriptor_slave_agent_rsp_fifo:in_data
	...
	wire  [349:0] dma_tx_descriptor_slave_agent_rsp_fifo_out_data;                  // dma_tx_descriptor_slave_agent_rsp_fifo:out_data -> dma_tx_descriptor_slave_agent:rf_sink_data
	...
	wire          dma_tx_descriptor_slave_agent_rdata_fifo_src_valid;               // dma_tx_descriptor_slave_agent:rdata_fifo_src_valid -> dma_tx_descriptor_slave_agent:rdata_fifo_sink_valid
	wire  [257:0] dma_tx_descriptor_slave_agent_rdata_fifo_src_data;                // dma_tx_descriptor_slave_agent:rdata_fifo_src_data -> dma_tx_descriptor_slave_agent:rdata_fifo_sink_data
	wire          dma_tx_descriptor_slave_agent_rdata_fifo_src_ready;               // dma_tx_descriptor_slave_agent:rdata_fifo_sink_ready -> dma_tx_descriptor_slave_agent:rdata_fifo_src_ready
	wire          cmd_mux_004_src_valid;                                            // cmd_mux_004:src_valid -> dma_tx_descriptor_slave_agent:cp_valid
	wire  [348:0] cmd_mux_004_src_data;                                             // cmd_mux_004:src_data -> dma_tx_descriptor_slave_agent:cp_data
	wire          cmd_mux_004_src_ready;                                            // dma_tx_descriptor_slave_agent:cp_ready -> cmd_mux_004:src_ready
	wire    [5:0] cmd_mux_004_src_channel;                                          // cmd_mux_004:src_channel -> dma_tx_descriptor_slave_agent:cp_channel
	wire          cmd_mux_004_src_startofpacket;                                    // cmd_mux_004:src_startofpacket -> dma_tx_descriptor_slave_agent:cp_startofpacket
	wire          cmd_mux_004_src_endofpacket;                                      // cmd_mux_004:src_endofpacket -> dma_tx_descriptor_slave_agent:cp_endofpacket
	...
	wire   [97:0] dma_rx_response_agent_rf_source_data;                             // dma_rx_response_agent:rf_source_data -> dma_rx_response_agent_rsp_fifo:in_data
	...
	wire   [97:0] dma_rx_response_agent_rsp_fifo_out_data;                          // dma_rx_response_agent_rsp_fifo:out_data -> dma_rx_response_agent:rf_sink_data
	...
	wire  [348:0] mem_bridge_m0_agent_cp_data;                                      // mem_bridge_m0_agent:cp_data -> router:sink_data
	...
	wire   [96:0] mac_control_port_agent_rp_data;                                   // mac_control_port_agent:rp_data -> router_001:sink_data
	...
	wire   [96:0] dma_rx_csr_agent_rp_data;                                         // dma_rx_csr_agent:rp_data -> router_002:sink_data
	...
	wire   [96:0] dma_tx_csr_agent_rp_data;                                         // dma_tx_csr_agent:rp_data -> router_003:sink_data
	...
	wire  [348:0] dma_rx_descriptor_slave_agent_rp_data;                            // dma_rx_descriptor_slave_agent:rp_data -> router_004:sink_data
	...
	wire  [348:0] router_004_src_data;                                              // router_004:src_data -> rsp_demux_003:sink_data
	...
	wire  [348:0] dma_tx_descriptor_slave_agent_rp_data;                            // dma_tx_descriptor_slave_agent:rp_data -> router_005:sink_data
	...
	wire  [348:0] router_005_src_data;                                              // router_005:src_data -> rsp_demux_004:sink_data
	...
	wire   [96:0] dma_rx_response_agent_rp_data;                                    // dma_rx_response_agent:rp_data -> router_006:sink_data
	...
	wire  [348:0] router_src_data;                                                  // router:src_data -> mem_bridge_m0_limiter:cmd_sink_data
	...
	wire  [348:0] mem_bridge_m0_limiter_cmd_src_data;                               // mem_bridge_m0_limiter:cmd_src_data -> cmd_demux:sink_data
	...
	wire  [348:0] rsp_mux_src_data;                                                 // rsp_mux:src_data -> mem_bridge_m0_limiter:rsp_sink_data
	...
	wire  [348:0] mem_bridge_m0_limiter_rsp_src_data;                               // mem_bridge_m0_limiter:rsp_src_data -> mem_bridge_m0_agent:rp_data
	...
	wire   [96:0] mac_control_port_burst_adapter_source0_data;                      // mac_control_port_burst_adapter:source0_data -> mac_control_port_agent:cp_data
	...
	wire   [96:0] dma_rx_csr_burst_adapter_source0_data;                            // dma_rx_csr_burst_adapter:source0_data -> dma_rx_csr_agent:cp_data
	...
	wire   [96:0] dma_tx_csr_burst_adapter_source0_data;                            // dma_tx_csr_burst_adapter:source0_data -> dma_tx_csr_agent:cp_data
	...
	wire   [96:0] dma_rx_response_burst_adapter_source0_data;                       // dma_rx_response_burst_adapter:source0_data -> dma_rx_response_agent:cp_data
	...
	wire  [348:0] cmd_demux_src0_data;                                              // cmd_demux:src0_data -> cmd_mux:sink0_data
	...
	wire  [348:0] cmd_demux_src1_data;                                              // cmd_demux:src1_data -> cmd_mux_001:sink0_data
	...
	wire  [348:0] cmd_demux_src2_data;                                              // cmd_demux:src2_data -> cmd_mux_002:sink0_data
	...
	wire  [348:0] cmd_demux_src3_data;                                              // cmd_demux:src3_data -> cmd_mux_003:sink0_data
	...
	wire  [348:0] cmd_demux_src4_data;                                              // cmd_demux:src4_data -> cmd_mux_004:sink0_data
	...
	wire  [348:0] cmd_demux_src5_data;                                              // cmd_demux:src5_data -> cmd_mux_005:sink0_data
	...
	wire  [348:0] rsp_demux_src0_data;                                              // rsp_demux:src0_data -> rsp_mux:sink0_data
	...
	wire  [348:0] rsp_demux_001_src0_data;                                          // rsp_demux_001:src0_data -> rsp_mux:sink1_data
	...
	wire  [348:0] rsp_demux_002_src0_data;                                          // rsp_demux_002:src0_data -> rsp_mux:sink2_data
	...
	wire  [348:0] rsp_demux_003_src0_data;                                          // rsp_demux_003:src0_data -> rsp_mux:sink3_data
	...
	wire  [348:0] rsp_demux_004_src0_data;                                          // rsp_demux_004:src0_data -> rsp_mux:sink4_data
	...
	wire  [348:0] rsp_demux_005_src0_data;                                          // rsp_demux_005:src0_data -> rsp_mux:sink5_data
	...
	wire          router_001_src_valid;                                             // router_001:src_valid -> mac_control_port_rsp_width_adapter:in_valid
	wire   [96:0] router_001_src_data;                                              // router_001:src_data -> mac_control_port_rsp_width_adapter:in_data
	wire          router_001_src_ready;                                             // mac_control_port_rsp_width_adapter:in_ready -> router_001:src_ready
	wire    [5:0] router_001_src_channel;                                           // router_001:src_channel -> mac_control_port_rsp_width_adapter:in_channel
	wire          router_001_src_startofpacket;                                     // router_001:src_startofpacket -> mac_control_port_rsp_width_adapter:in_startofpacket
	wire          router_001_src_endofpacket;                                       // router_001:src_endofpacket -> mac_control_port_rsp_width_adapter:in_endofpacket
	wire          mac_control_port_rsp_width_adapter_src_valid;                     // mac_control_port_rsp_width_adapter:out_valid -> rsp_demux:sink_valid
	wire  [348:0] mac_control_port_rsp_width_adapter_src_data;                      // mac_control_port_rsp_width_adapter:out_data -> rsp_demux:sink_data
	wire          mac_control_port_rsp_width_adapter_src_ready;                     // rsp_demux:sink_ready -> mac_control_port_rsp_width_adapter:out_ready
	wire    [5:0] mac_control_port_rsp_width_adapter_src_channel;                   // mac_control_port_rsp_width_adapter:out_channel -> rsp_demux:sink_channel
	wire          mac_control_port_rsp_width_adapter_src_startofpacket;             // mac_control_port_rsp_width_adapter:out_startofpacket -> rsp_demux:sink_startofpacket
	wire          mac_control_port_rsp_width_adapter_src_endofpacket;               // mac_control_port_rsp_width_adapter:out_endofpacket -> rsp_demux:sink_endofpacket
	wire          router_002_src_valid;                                             // router_002:src_valid -> dma_rx_csr_rsp_width_adapter:in_valid
	wire   [96:0] router_002_src_data;                                              // router_002:src_data -> dma_rx_csr_rsp_width_adapter:in_data
	wire          router_002_src_ready;                                             // dma_rx_csr_rsp_width_adapter:in_ready -> router_002:src_ready
	wire    [5:0] router_002_src_channel;                                           // router_002:src_channel -> dma_rx_csr_rsp_width_adapter:in_channel
	wire          router_002_src_startofpacket;                                     // router_002:src_startofpacket -> dma_rx_csr_rsp_width_adapter:in_startofpacket
	wire          router_002_src_endofpacket;                                       // router_002:src_endofpacket -> dma_rx_csr_rsp_width_adapter:in_endofpacket
	wire          dma_rx_csr_rsp_width_adapter_src_valid;                           // dma_rx_csr_rsp_width_adapter:out_valid -> rsp_demux_001:sink_valid
	wire  [348:0] dma_rx_csr_rsp_width_adapter_src_data;                            // dma_rx_csr_rsp_width_adapter:out_data -> rsp_demux_001:sink_data
	wire          dma_rx_csr_rsp_width_adapter_src_ready;                           // rsp_demux_001:sink_ready -> dma_rx_csr_rsp_width_adapter:out_ready
	wire    [5:0] dma_rx_csr_rsp_width_adapter_src_channel;                         // dma_rx_csr_rsp_width_adapter:out_channel -> rsp_demux_001:sink_channel
	wire          dma_rx_csr_rsp_width_adapter_src_startofpacket;                   // dma_rx_csr_rsp_width_adapter:out_startofpacket -> rsp_demux_001:sink_startofpacket
	wire          dma_rx_csr_rsp_width_adapter_src_endofpacket;                     // dma_rx_csr_rsp_width_adapter:out_endofpacket -> rsp_demux_001:sink_endofpacket
	wire          router_003_src_valid;                                             // router_003:src_valid -> dma_tx_csr_rsp_width_adapter:in_valid
	wire   [96:0] router_003_src_data;                                              // router_003:src_data -> dma_tx_csr_rsp_width_adapter:in_data
	wire          router_003_src_ready;                                             // dma_tx_csr_rsp_width_adapter:in_ready -> router_003:src_ready
	wire    [5:0] router_003_src_channel;                                           // router_003:src_channel -> dma_tx_csr_rsp_width_adapter:in_channel
	wire          router_003_src_startofpacket;                                     // router_003:src_startofpacket -> dma_tx_csr_rsp_width_adapter:in_startofpacket
	wire          router_003_src_endofpacket;                                       // router_003:src_endofpacket -> dma_tx_csr_rsp_width_adapter:in_endofpacket
	wire          dma_tx_csr_rsp_width_adapter_src_valid;                           // dma_tx_csr_rsp_width_adapter:out_valid -> rsp_demux_002:sink_valid
	wire  [348:0] dma_tx_csr_rsp_width_adapter_src_data;                            // dma_tx_csr_rsp_width_adapter:out_data -> rsp_demux_002:sink_data
	wire          dma_tx_csr_rsp_width_adapter_src_ready;                           // rsp_demux_002:sink_ready -> dma_tx_csr_rsp_width_adapter:out_ready
	wire    [5:0] dma_tx_csr_rsp_width_adapter_src_channel;                         // dma_tx_csr_rsp_width_adapter:out_channel -> rsp_demux_002:sink_channel
	wire          dma_tx_csr_rsp_width_adapter_src_startofpacket;                   // dma_tx_csr_rsp_width_adapter:out_startofpacket -> rsp_demux_002:sink_startofpacket
	wire          dma_tx_csr_rsp_width_adapter_src_endofpacket;                     // dma_tx_csr_rsp_width_adapter:out_endofpacket -> rsp_demux_002:sink_endofpacket
	wire          router_006_src_valid;                                             // router_006:src_valid -> dma_rx_response_rsp_width_adapter:in_valid
	wire   [96:0] router_006_src_data;                                              // router_006:src_data -> dma_rx_response_rsp_width_adapter:in_data
	wire          router_006_src_ready;                                             // dma_rx_response_rsp_width_adapter:in_ready -> router_006:src_ready
	wire    [5:0] router_006_src_channel;                                           // router_006:src_channel -> dma_rx_response_rsp_width_adapter:in_channel
	wire          router_006_src_startofpacket;                                     // router_006:src_startofpacket -> dma_rx_response_rsp_width_adapter:in_startofpacket
	wire          router_006_src_endofpacket;                                       // router_006:src_endofpacket -> dma_rx_response_rsp_width_adapter:in_endofpacket
	wire          dma_rx_response_rsp_width_adapter_src_valid;                      // dma_rx_response_rsp_width_adapter:out_valid -> rsp_demux_005:sink_valid
	wire  [348:0] dma_rx_response_rsp_width_adapter_src_data;                       // dma_rx_response_rsp_width_adapter:out_data -> rsp_demux_005:sink_data
	wire          dma_rx_response_rsp_width_adapter_src_ready;                      // rsp_demux_005:sink_ready -> dma_rx_response_rsp_width_adapter:out_ready
	wire    [5:0] dma_rx_response_rsp_width_adapter_src_channel;                    // dma_rx_response_rsp_width_adapter:out_channel -> rsp_demux_005:sink_channel
	wire          dma_rx_response_rsp_width_adapter_src_startofpacket;              // dma_rx_response_rsp_width_adapter:out_startofpacket -> rsp_demux_005:sink_startofpacket
	wire          dma_rx_response_rsp_width_adapter_src_endofpacket;                // dma_rx_response_rsp_width_adapter:out_endofpacket -> rsp_demux_005:sink_endofpacket
	wire          cmd_mux_src_valid;                                                // cmd_mux:src_valid -> mac_control_port_cmd_width_adapter:in_valid
	wire  [348:0] cmd_mux_src_data;                                                 // cmd_mux:src_data -> mac_control_port_cmd_width_adapter:in_data
	wire          cmd_mux_src_ready;                                                // mac_control_port_cmd_width_adapter:in_ready -> cmd_mux:src_ready
	wire    [5:0] cmd_mux_src_channel;                                              // cmd_mux:src_channel -> mac_control_port_cmd_width_adapter:in_channel
	wire          cmd_mux_src_startofpacket;                                        // cmd_mux:src_startofpacket -> mac_control_port_cmd_width_adapter:in_startofpacket
	wire          cmd_mux_src_endofpacket;                                          // cmd_mux:src_endofpacket -> mac_control_port_cmd_width_adapter:in_endofpacket
	wire          mac_control_port_cmd_width_adapter_src_valid;                     // mac_control_port_cmd_width_adapter:out_valid -> mac_control_port_burst_adapter:sink0_valid
	wire   [96:0] mac_control_port_cmd_width_adapter_src_data;                      // mac_control_port_cmd_width_adapter:out_data -> mac_control_port_burst_adapter:sink0_data
	wire          mac_control_port_cmd_width_adapter_src_ready;                     // mac_control_port_burst_adapter:sink0_ready -> mac_control_port_cmd_width_adapter:out_ready
	wire    [5:0] mac_control_port_cmd_width_adapter_src_channel;                   // mac_control_port_cmd_width_adapter:out_channel -> mac_control_port_burst_adapter:sink0_channel
	wire          mac_control_port_cmd_width_adapter_src_startofpacket;             // mac_control_port_cmd_width_adapter:out_startofpacket -> mac_control_port_burst_adapter:sink0_startofpacket
	wire          mac_control_port_cmd_width_adapter_src_endofpacket;               // mac_control_port_cmd_width_adapter:out_endofpacket -> mac_control_port_burst_adapter:sink0_endofpacket
	wire          cmd_mux_001_src_valid;                                            // cmd_mux_001:src_valid -> dma_rx_csr_cmd_width_adapter:in_valid
	wire  [348:0] cmd_mux_001_src_data;                                             // cmd_mux_001:src_data -> dma_rx_csr_cmd_width_adapter:in_data
	wire          cmd_mux_001_src_ready;                                            // dma_rx_csr_cmd_width_adapter:in_ready -> cmd_mux_001:src_ready
	wire    [5:0] cmd_mux_001_src_channel;                                          // cmd_mux_001:src_channel -> dma_rx_csr_cmd_width_adapter:in_channel
	wire          cmd_mux_001_src_startofpacket;                                    // cmd_mux_001:src_startofpacket -> dma_rx_csr_cmd_width_adapter:in_startofpacket
	wire          cmd_mux_001_src_endofpacket;                                      // cmd_mux_001:src_endofpacket -> dma_rx_csr_cmd_width_adapter:in_endofpacket
	wire          dma_rx_csr_cmd_width_adapter_src_valid;                           // dma_rx_csr_cmd_width_adapter:out_valid -> dma_rx_csr_burst_adapter:sink0_valid
	wire   [96:0] dma_rx_csr_cmd_width_adapter_src_data;                            // dma_rx_csr_cmd_width_adapter:out_data -> dma_rx_csr_burst_adapter:sink0_data
	wire          dma_rx_csr_cmd_width_adapter_src_ready;                           // dma_rx_csr_burst_adapter:sink0_ready -> dma_rx_csr_cmd_width_adapter:out_ready
	wire    [5:0] dma_rx_csr_cmd_width_adapter_src_channel;                         // dma_rx_csr_cmd_width_adapter:out_channel -> dma_rx_csr_burst_adapter:sink0_channel
	wire          dma_rx_csr_cmd_width_adapter_src_startofpacket;                   // dma_rx_csr_cmd_width_adapter:out_startofpacket -> dma_rx_csr_burst_adapter:sink0_startofpacket
	wire          dma_rx_csr_cmd_width_adapter_src_endofpacket;                     // dma_rx_csr_cmd_width_adapter:out_endofpacket -> dma_rx_csr_burst_adapter:sink0_endofpacket
	wire          cmd_mux_002_src_valid;                                            // cmd_mux_002:src_valid -> dma_tx_csr_cmd_width_adapter:in_valid
	wire  [348:0] cmd_mux_002_src_data;                                             // cmd_mux_002:src_data -> dma_tx_csr_cmd_width_adapter:in_data
	wire          cmd_mux_002_src_ready;                                            // dma_tx_csr_cmd_width_adapter:in_ready -> cmd_mux_002:src_ready
	wire    [5:0] cmd_mux_002_src_channel;                                          // cmd_mux_002:src_channel -> dma_tx_csr_cmd_width_adapter:in_channel
	wire          cmd_mux_002_src_startofpacket;                                    // cmd_mux_002:src_startofpacket -> dma_tx_csr_cmd_width_adapter:in_startofpacket
	wire          cmd_mux_002_src_endofpacket;                                      // cmd_mux_002:src_endofpacket -> dma_tx_csr_cmd_width_adapter:in_endofpacket
	wire          dma_tx_csr_cmd_width_adapter_src_valid;                           // dma_tx_csr_cmd_width_adapter:out_valid -> dma_tx_csr_burst_adapter:sink0_valid
	wire   [96:0] dma_tx_csr_cmd_width_adapter_src_data;                            // dma_tx_csr_cmd_width_adapter:out_data -> dma_tx_csr_burst_adapter:sink0_data
	wire          dma_tx_csr_cmd_width_adapter_src_ready;                           // dma_tx_csr_burst_adapter:sink0_ready -> dma_tx_csr_cmd_width_adapter:out_ready
	wire    [5:0] dma_tx_csr_cmd_width_adapter_src_channel;                         // dma_tx_csr_cmd_width_adapter:out_channel -> dma_tx_csr_burst_adapter:sink0_channel
	wire          dma_tx_csr_cmd_width_adapter_src_startofpacket;                   // dma_tx_csr_cmd_width_adapter:out_startofpacket -> dma_tx_csr_burst_adapter:sink0_startofpacket
	wire          dma_tx_csr_cmd_width_adapter_src_endofpacket;                     // dma_tx_csr_cmd_width_adapter:out_endofpacket -> dma_tx_csr_burst_adapter:sink0_endofpacket
	wire          cmd_mux_005_src_valid;                                            // cmd_mux_005:src_valid -> dma_rx_response_cmd_width_adapter:in_valid
	wire  [348:0] cmd_mux_005_src_data;                                             // cmd_mux_005:src_data -> dma_rx_response_cmd_width_adapter:in_data
	wire          cmd_mux_005_src_ready;                                            // dma_rx_response_cmd_width_adapter:in_ready -> cmd_mux_005:src_ready
	wire    [5:0] cmd_mux_005_src_channel;                                          // cmd_mux_005:src_channel -> dma_rx_response_cmd_width_adapter:in_channel
	wire          cmd_mux_005_src_startofpacket;                                    // cmd_mux_005:src_startofpacket -> dma_rx_response_cmd_width_adapter:in_startofpacket
	wire          cmd_mux_005_src_endofpacket;                                      // cmd_mux_005:src_endofpacket -> dma_rx_response_cmd_width_adapter:in_endofpacket
	wire          dma_rx_response_cmd_width_adapter_src_valid;                      // dma_rx_response_cmd_width_adapter:out_valid -> dma_rx_response_burst_adapter:sink0_valid
	wire   [96:0] dma_rx_response_cmd_width_adapter_src_data;                       // dma_rx_response_cmd_width_adapter:out_data -> dma_rx_response_burst_adapter:sink0_data
	wire          dma_rx_response_cmd_width_adapter_src_ready;                      // dma_rx_response_burst_adapter:sink0_ready -> dma_rx_response_cmd_width_adapter:out_ready
	wire    [5:0] dma_rx_response_cmd_width_adapter_src_channel;                    // dma_rx_response_cmd_width_adapter:out_channel -> dma_rx_response_burst_adapter:sink0_channel
	wire          dma_rx_response_cmd_width_adapter_src_startofpacket;              // dma_rx_response_cmd_width_adapter:out_startofpacket -> dma_rx_response_burst_adapter:sink0_startofpacket
	wire          dma_rx_response_cmd_width_adapter_src_endofpacket;                // dma_rx_response_cmd_width_adapter:out_endofpacket -> dma_rx_response_burst_adapter:sink0_endofpacket
	...
	ethernet_altera_merlin_master_translator_181_mhudjri #(
		...
		.uav_burstcount         (mem_bridge_m0_translator_avalon_universal_master_0_burstcount),    //  output,    width = 6,                          .burstcount
		...
		.uav_byteenable         (mem_bridge_m0_translator_avalon_universal_master_0_byteenable),    //  output,   width = 32,                          .byteenable
		.uav_readdata           (mem_bridge_m0_translator_avalon_universal_master_0_readdata),      //   input,  width = 256,                          .readdata
		.uav_writedata          (mem_bridge_m0_translator_avalon_universal_master_0_writedata),     //  output,  width = 256,                          .writedata
		...
		.av_burstcount          (mem_bridge_m0_burstcount),                                         //   input,    width = 1,                          .burstcount
		.av_byteenable          (mem_bridge_m0_byteenable),                                         //   input,   width = 32,                          .byteenable
		.av_read                (mem_bridge_m0_read),                                               //   input,    width = 1,                          .read
		.av_readdata            (mem_bridge_m0_readdata),                                           //  output,  width = 256,                          .readdata
		...
		.av_writedata           (mem_bridge_m0_writedata),                                          //   input,  width = 256,                          .writedata
	...
	ethernet_altera_merlin_master_agent_181_t5eyqrq #(
		...
		.PKT_BARRIER_H             (341),
		.PKT_BARRIER_L             (340),
		.PKT_ORI_BURST_SIZE_H      (339),
		.PKT_ORI_BURST_SIZE_L      (337),
		.PKT_RESPONSE_STATUS_H     (336),
		.PKT_RESPONSE_STATUS_L     (335),
		.PKT_QOS_H                 (320),
		.PKT_QOS_L                 (320),
		.PKT_DATA_SIDEBAND_H       (318),
		.PKT_DATA_SIDEBAND_L       (318),
		.PKT_ADDR_SIDEBAND_H       (317),
		.PKT_ADDR_SIDEBAND_L       (317),
		.PKT_BURST_TYPE_H          (316),
		.PKT_BURST_TYPE_L          (315),
		.PKT_CACHE_H               (334),
		.PKT_CACHE_L               (331),
		.PKT_THREAD_ID_H           (327),
		.PKT_THREAD_ID_L           (327),
		...
		.PKT_TRANS_EXCLUSIVE       (304),
		.PKT_TRANS_LOCK            (303),
		.PKT_BEGIN_BURST           (319),
		.PKT_PROTECTION_H          (330),
		.PKT_PROTECTION_L          (328),
		.PKT_BURSTWRAP_H           (311),
		.PKT_BURSTWRAP_L           (311),
		.PKT_BYTE_CNT_H            (310),
		.PKT_BYTE_CNT_L            (305),
		...
		.av_writedata          (mem_bridge_m0_translator_avalon_universal_master_0_writedata),     //   input,  width = 256,          .writedata
		.av_readdata           (mem_bridge_m0_translator_avalon_universal_master_0_readdata),      //  output,  width = 256,          .readdata
		...
		.av_byteenable         (mem_bridge_m0_translator_avalon_universal_master_0_byteenable),    //   input,   width = 32,          .byteenable
		.av_burstcount         (mem_bridge_m0_translator_avalon_universal_master_0_burstcount),    //   input,    width = 6,          .burstcount
		...
		.cp_data               (mem_bridge_m0_agent_cp_data),                                      //  output,  width = 349,          .data
		...
		.rp_data               (mem_bridge_m0_limiter_rsp_src_data),                               //   input,  width = 349,          .data
	...
	ethernet_altera_merlin_slave_agent_181_a7g37xa #(
		...
		.rp_data                 (mac_control_port_agent_rp_data),                       //  output,  width = 97,                .data
		...
		.cp_data                 (mac_control_port_burst_adapter_source0_data),          //   input,  width = 97,                .data
		...
		.rf_sink_data            (mac_control_port_agent_rsp_fifo_out_data),             //   input,  width = 98,                .data
		...
		.rf_source_data          (mac_control_port_agent_rf_source_data),                //  output,  width = 98,                .data
	...
	ethernet_altera_avalon_sc_fifo_181_oywqgnq #(
		...
		.clk               (clock_out_clk_clk),                                 //   input,   width = 1,       clk.clk
		.reset             (mem_bridge_reset_reset_bridge_in_reset_reset),      //   input,   width = 1, clk_reset.reset
		.in_data           (mac_control_port_agent_rf_source_data),             //   input,  width = 98,        in.data
		...
		.out_data          (mac_control_port_agent_rsp_fifo_out_data),          //  output,  width = 98,       out.data
	...
	ethernet_altera_merlin_slave_agent_181_a7g37xa #(
		...
		.rp_data                 (dma_rx_csr_agent_rp_data),                       //  output,  width = 97,                .data
		...
		.cp_data                 (dma_rx_csr_burst_adapter_source0_data),          //   input,  width = 97,                .data
		...
		.rf_sink_data            (dma_rx_csr_agent_rsp_fifo_out_data),             //   input,  width = 98,                .data
		...
		.rf_source_data          (dma_rx_csr_agent_rf_source_data),                //  output,  width = 98,                .data
	...
	ethernet_altera_avalon_sc_fifo_181_oywqgnq #(
		...
		.clk               (clock_out_clk_clk),                            //   input,   width = 1,       clk.clk
		.reset             (mem_bridge_reset_reset_bridge_in_reset_reset), //   input,   width = 1, clk_reset.reset
		.in_data           (dma_rx_csr_agent_rf_source_data),              //   input,  width = 98,        in.data
		...
		.out_data          (dma_rx_csr_agent_rsp_fifo_out_data),           //  output,  width = 98,       out.data
	...
	ethernet_altera_merlin_slave_agent_181_a7g37xa #(
		...
		.rp_data                 (dma_tx_csr_agent_rp_data),                       //  output,  width = 97,                .data
		...
		.cp_data                 (dma_tx_csr_burst_adapter_source0_data),          //   input,  width = 97,                .data
		...
		.rf_sink_data            (dma_tx_csr_agent_rsp_fifo_out_data),             //   input,  width = 98,                .data
		...
		.rf_source_data          (dma_tx_csr_agent_rf_source_data),                //  output,  width = 98,                .data
	...
	ethernet_altera_avalon_sc_fifo_181_oywqgnq #(
		...
		.clk               (clock_out_clk_clk),                            //   input,   width = 1,       clk.clk
		.reset             (mem_bridge_reset_reset_bridge_in_reset_reset), //   input,   width = 1, clk_reset.reset
		.in_data           (dma_tx_csr_agent_rf_source_data),              //   input,  width = 98,        in.data
		...
		.out_data          (dma_tx_csr_agent_rsp_fifo_out_data),           //  output,  width = 98,       out.data
	...
	ethernet_altera_merlin_slave_agent_181_a7g37xa #(
		...
		.rp_data                 (dma_rx_descriptor_slave_agent_rp_data),                    //  output,  width = 349,                .data
		...
		.cp_data                 (cmd_mux_003_src_data),                                     //   input,  width = 349,                .data
		...
		.rf_sink_data            (dma_rx_descriptor_slave_agent_rsp_fifo_out_data),          //   input,  width = 350,                .data
		...
		.rf_source_data          (dma_rx_descriptor_slave_agent_rf_source_data),             //  output,  width = 350,                .data
		.rdata_fifo_sink_ready   (dma_rx_descriptor_slave_agent_rdata_fifo_src_ready),       //  output,    width = 1, rdata_fifo_sink.ready
		.rdata_fifo_sink_valid   (dma_rx_descriptor_slave_agent_rdata_fifo_src_valid),       //   input,    width = 1,                .valid
		.rdata_fifo_sink_data    (dma_rx_descriptor_slave_agent_rdata_fifo_src_data),        //   input,  width = 258,                .data
	...
	ethernet_altera_avalon_sc_fifo_181_oywqgnq #(
		...
		.clk               (clock_out_clk_clk),                                        //   input,    width = 1,       clk.clk
		.reset             (mem_bridge_reset_reset_bridge_in_reset_reset),             //   input,    width = 1, clk_reset.reset
		.in_data           (dma_rx_descriptor_slave_agent_rf_source_data),             //   input,  width = 350,        in.data
		...
		.out_data          (dma_rx_descriptor_slave_agent_rsp_fifo_out_data),          //  output,  width = 350,       out.data
	...
	ethernet_altera_merlin_slave_agent_181_a7g37xa #(
		...
		.rp_data                 (dma_tx_descriptor_slave_agent_rp_data),                    //  output,  width = 349,                .data
		...
		.cp_data                 (cmd_mux_004_src_data),                                     //   input,  width = 349,                .data
		...
		.rf_sink_data            (dma_tx_descriptor_slave_agent_rsp_fifo_out_data),          //   input,  width = 350,                .data
		...
		.rf_source_data          (dma_tx_descriptor_slave_agent_rf_source_data),             //  output,  width = 350,                .data
		.rdata_fifo_sink_ready   (dma_tx_descriptor_slave_agent_rdata_fifo_src_ready),       //  output,    width = 1, rdata_fifo_sink.ready
		.rdata_fifo_sink_valid   (dma_tx_descriptor_slave_agent_rdata_fifo_src_valid),       //   input,    width = 1,                .valid
		.rdata_fifo_sink_data    (dma_tx_descriptor_slave_agent_rdata_fifo_src_data),        //   input,  width = 258,                .data
	...
	ethernet_altera_avalon_sc_fifo_181_oywqgnq #(
		...
		.clk               (clock_out_clk_clk),                                        //   input,    width = 1,       clk.clk
		.reset             (mem_bridge_reset_reset_bridge_in_reset_reset),             //   input,    width = 1, clk_reset.reset
		.in_data           (dma_tx_descriptor_slave_agent_rf_source_data),             //   input,  width = 350,        in.data
		...
		.out_data          (dma_tx_descriptor_slave_agent_rsp_fifo_out_data),          //  output,  width = 350,       out.data
	...
	ethernet_altera_merlin_slave_agent_181_a7g37xa #(
		...
		.rp_data                 (dma_rx_response_agent_rp_data),                       //  output,  width = 97,                .data
		...
		.cp_data                 (dma_rx_response_burst_adapter_source0_data),          //   input,  width = 97,                .data
		...
		.rf_sink_data            (dma_rx_response_agent_rsp_fifo_out_data),             //   input,  width = 98,                .data
		...
		.rf_source_data          (dma_rx_response_agent_rf_source_data),                //  output,  width = 98,                .data
	...
	ethernet_altera_avalon_sc_fifo_181_oywqgnq #(
		...
		.clk               (clock_out_clk_clk),                                //   input,   width = 1,       clk.clk
		.reset             (mem_bridge_reset_reset_bridge_in_reset_reset),     //   input,   width = 1, clk_reset.reset
		.in_data           (dma_rx_response_agent_rf_source_data),             //   input,  width = 98,        in.data
		...
		.out_data          (dma_rx_response_agent_rsp_fifo_out_data),          //  output,  width = 98,       out.data
	...
	ethernet_altera_merlin_router_181_rw6spxy router (
		...
		.sink_data          (mem_bridge_m0_agent_cp_data),                  //   input,  width = 349,          .data
		...
		.src_data           (router_src_data),                              //  output,  width = 349,          .data
		.src_channel        (router_src_channel),                           //  output,    width = 6,          .channel
		.src_startofpacket  (router_src_startofpacket),                     //  output,    width = 1,          .startofpacket
		.src_endofpacket    (router_src_endofpacket)                        //  output,    width = 1,          .endofpacket
	);

	ethernet_altera_merlin_router_181_h3cehxq router_001 (
		...
		.sink_data          (mac_control_port_agent_rp_data),               //   input,  width = 97,          .data
	...
	ethernet_altera_merlin_router_181_h3cehxq router_003 (
		...
		.src_data           (router_003_src_data),                          //  output,  width = 97,          .data
	...
	ethernet_altera_merlin_router_181_na5mldq router_004 (
		...
		.sink_data          (dma_rx_descriptor_slave_agent_rp_data),          //   input,  width = 349,          .data
		...
		.src_data           (router_004_src_data),                            //  output,  width = 349,          .data
	...
	ethernet_altera_merlin_router_181_na5mldq router_005 (
		...
		.sink_data          (dma_tx_descriptor_slave_agent_rp_data),          //   input,  width = 349,          .data
		...
		.src_data           (router_005_src_data),                            //  output,  width = 349,          .data
	...
	ethernet_altera_merlin_router_181_h3cehxq router_006 (
		...
		.sink_data          (dma_rx_response_agent_rp_data),                //   input,  width = 97,          .data
		...
		.src_data           (router_006_src_data),                          //  output,  width = 97,          .data
	...
	ethernet_altera_merlin_traffic_limiter_181_reppfiq #(
		...
		.cmd_sink_data          (router_src_data),                              //   input,  width = 349,          .data
		...
		.cmd_src_data           (mem_bridge_m0_limiter_cmd_src_data),           //  output,  width = 349,          .data
		...
		.rsp_sink_data          (rsp_mux_src_data),                             //   input,  width = 349,          .data
		...
		.rsp_src_data           (mem_bridge_m0_limiter_rsp_src_data),           //  output,  width = 349,          .data
	...
	ethernet_altera_merlin_burst_adapter_181_ppn5zgy #(
		.PKT_ADDR_H                (46),
		.PKT_ADDR_L                (36),
		.PKT_BEGIN_BURST           (67),
		.PKT_BYTE_CNT_H            (58),
		...
		.sink0_valid           (mac_control_port_cmd_width_adapter_src_valid),         //   input,   width = 1,     sink0.valid
		.sink0_data            (mac_control_port_cmd_width_adapter_src_data),          //   input,  width = 97,          .data
		.sink0_channel         (mac_control_port_cmd_width_adapter_src_channel),       //   input,   width = 6,          .channel
		.sink0_startofpacket   (mac_control_port_cmd_width_adapter_src_startofpacket), //   input,   width = 1,          .startofpacket
		.sink0_endofpacket     (mac_control_port_cmd_width_adapter_src_endofpacket),   //   input,   width = 1,          .endofpacket
		.sink0_ready           (mac_control_port_cmd_width_adapter_src_ready),         //  output,   width = 1,          .ready
		.source0_valid         (mac_control_port_burst_adapter_source0_valid),         //  output,   width = 1,   source0.valid
		.source0_data          (mac_control_port_burst_adapter_source0_data),          //  output,  width = 97,          .data
	...
	ethernet_altera_merlin_burst_adapter_181_ppn5zgy #(
		...
		.clk                   (clock_out_clk_clk),                              //   input,   width = 1,       cr0.clk
		.reset                 (mem_bridge_reset_reset_bridge_in_reset_reset),   //   input,   width = 1, cr0_reset.reset
		.sink0_valid           (dma_rx_csr_cmd_width_adapter_src_valid),         //   input,   width = 1,     sink0.valid
		.sink0_data            (dma_rx_csr_cmd_width_adapter_src_data),          //   input,  width = 97,          .data
		.sink0_channel         (dma_rx_csr_cmd_width_adapter_src_channel),       //   input,   width = 6,          .channel
		.sink0_startofpacket   (dma_rx_csr_cmd_width_adapter_src_startofpacket), //   input,   width = 1,          .startofpacket
		.sink0_endofpacket     (dma_rx_csr_cmd_width_adapter_src_endofpacket),   //   input,   width = 1,          .endofpacket
		.sink0_ready           (dma_rx_csr_cmd_width_adapter_src_ready),         //  output,   width = 1,          .ready
		.source0_valid         (dma_rx_csr_burst_adapter_source0_valid),         //  output,   width = 1,   source0.valid
		.source0_data          (dma_rx_csr_burst_adapter_source0_data),          //  output,  width = 97,          .data
	...
	ethernet_altera_merlin_burst_adapter_181_ppn5zgy #(
		...
		.clk                   (clock_out_clk_clk),                              //   input,   width = 1,       cr0.clk
		.reset                 (mem_bridge_reset_reset_bridge_in_reset_reset),   //   input,   width = 1, cr0_reset.reset
		.sink0_valid           (dma_tx_csr_cmd_width_adapter_src_valid),         //   input,   width = 1,     sink0.valid
		.sink0_data            (dma_tx_csr_cmd_width_adapter_src_data),          //   input,  width = 97,          .data
		.sink0_channel         (dma_tx_csr_cmd_width_adapter_src_channel),       //   input,   width = 6,          .channel
		.sink0_startofpacket   (dma_tx_csr_cmd_width_adapter_src_startofpacket), //   input,   width = 1,          .startofpacket
		.sink0_endofpacket     (dma_tx_csr_cmd_width_adapter_src_endofpacket),   //   input,   width = 1,          .endofpacket
		.sink0_ready           (dma_tx_csr_cmd_width_adapter_src_ready),         //  output,   width = 1,          .ready
		.source0_valid         (dma_tx_csr_burst_adapter_source0_valid),         //  output,   width = 1,   source0.valid
		.source0_data          (dma_tx_csr_burst_adapter_source0_data),          //  output,  width = 97,          .data
	...
	ethernet_altera_merlin_burst_adapter_181_ppn5zgy #(
		...
		.clk                   (clock_out_clk_clk),                                   //   input,   width = 1,       cr0.clk
		.reset                 (mem_bridge_reset_reset_bridge_in_reset_reset),        //   input,   width = 1, cr0_reset.reset
		.sink0_valid           (dma_rx_response_cmd_width_adapter_src_valid),         //   input,   width = 1,     sink0.valid
		.sink0_data            (dma_rx_response_cmd_width_adapter_src_data),          //   input,  width = 97,          .data
		.sink0_channel         (dma_rx_response_cmd_width_adapter_src_channel),       //   input,   width = 6,          .channel
		.sink0_startofpacket   (dma_rx_response_cmd_width_adapter_src_startofpacket), //   input,   width = 1,          .startofpacket
		.sink0_endofpacket     (dma_rx_response_cmd_width_adapter_src_endofpacket),   //   input,   width = 1,          .endofpacket
		.sink0_ready           (dma_rx_response_cmd_width_adapter_src_ready),         //  output,   width = 1,          .ready
		.source0_valid         (dma_rx_response_burst_adapter_source0_valid),         //  output,   width = 1,   source0.valid
		.source0_data          (dma_rx_response_burst_adapter_source0_data),          //  output,  width = 97,          .data
	...
	ethernet_altera_merlin_demultiplexer_181_kqxvxny cmd_demux (
		.clk                (clock_out_clk_clk),                            //   input,    width = 1,        clk.clk
		.reset              (mem_bridge_reset_reset_bridge_in_reset_reset), //   input,    width = 1,  clk_reset.reset
		...
		.sink_data          (mem_bridge_m0_limiter_cmd_src_data),           //   input,  width = 349,           .data
		...
		.src2_data          (cmd_demux_src2_data),                          //  output,  width = 349,           .data
		...
		.src3_data          (cmd_demux_src3_data),                          //  output,  width = 349,           .data
		...
		.src4_data          (cmd_demux_src4_data),                          //  output,  width = 349,           .data
		...
		.src5_data          (cmd_demux_src5_data),                          //  output,  width = 349,           .data
	...
	ethernet_altera_merlin_multiplexer_181_cudbt2a cmd_mux (
		.clk                 (clock_out_clk_clk),                            //   input,    width = 1,       clk.clk
		.reset               (mem_bridge_reset_reset_bridge_in_reset_reset), //   input,    width = 1, clk_reset.reset
		.src_ready           (cmd_mux_src_ready),                            //   input,    width = 1,       src.ready
		.src_valid           (cmd_mux_src_valid),                            //  output,    width = 1,          .valid
		.src_data            (cmd_mux_src_data),                             //  output,  width = 349,          .data
		...
		.sink0_data          (cmd_demux_src0_data),                          //   input,  width = 349,          .data
		.sink0_startofpacket (cmd_demux_src0_startofpacket),                 //   input,    width = 1,          .startofpacket
		.sink0_endofpacket   (cmd_demux_src0_endofpacket)                    //   input,    width = 1,          .endofpacket
	);

	ethernet_altera_merlin_multiplexer_181_cudbt2a cmd_mux_001 (
		.clk                 (clock_out_clk_clk),                            //   input,    width = 1,       clk.clk
		.reset               (mem_bridge_reset_reset_bridge_in_reset_reset), //   input,    width = 1, clk_reset.reset
		.src_ready           (cmd_mux_001_src_ready),                        //   input,    width = 1,       src.ready
		.src_valid           (cmd_mux_001_src_valid),                        //  output,    width = 1,          .valid
		.src_data            (cmd_mux_001_src_data),                         //  output,  width = 349,          .data
		...
		.sink0_data          (cmd_demux_src1_data),                          //   input,  width = 349,          .data
	...
	ethernet_altera_merlin_multiplexer_181_cudbt2a cmd_mux_002 (
		.clk                 (clock_out_clk_clk),                            //   input,    width = 1,       clk.clk
		.reset               (mem_bridge_reset_reset_bridge_in_reset_reset), //   input,    width = 1, clk_reset.reset
		.src_ready           (cmd_mux_002_src_ready),                        //   input,    width = 1,       src.ready
		.src_valid           (cmd_mux_002_src_valid),                        //  output,    width = 1,          .valid
		.src_data            (cmd_mux_002_src_data),                         //  output,  width = 349,          .data
		...
		.sink0_data          (cmd_demux_src2_data),                          //   input,  width = 349,          .data
	...
	ethernet_altera_merlin_multiplexer_181_cudbt2a cmd_mux_003 (
		.clk                 (clock_out_clk_clk),                            //   input,    width = 1,       clk.clk
		.reset               (mem_bridge_reset_reset_bridge_in_reset_reset), //   input,    width = 1, clk_reset.reset
		.src_ready           (cmd_mux_003_src_ready),                        //   input,    width = 1,       src.ready
		.src_valid           (cmd_mux_003_src_valid),                        //  output,    width = 1,          .valid
		.src_data            (cmd_mux_003_src_data),                         //  output,  width = 349,          .data
		...
		.sink0_data          (cmd_demux_src3_data),                          //   input,  width = 349,          .data
	...
	ethernet_altera_merlin_multiplexer_181_cudbt2a cmd_mux_004 (
		.clk                 (clock_out_clk_clk),                            //   input,    width = 1,       clk.clk
		.reset               (mem_bridge_reset_reset_bridge_in_reset_reset), //   input,    width = 1, clk_reset.reset
		.src_ready           (cmd_mux_004_src_ready),                        //   input,    width = 1,       src.ready
		.src_valid           (cmd_mux_004_src_valid),                        //  output,    width = 1,          .valid
		.src_data            (cmd_mux_004_src_data),                         //  output,  width = 349,          .data
		...
		.sink0_data          (cmd_demux_src4_data),                          //   input,  width = 349,          .data
	...
	ethernet_altera_merlin_multiplexer_181_cudbt2a cmd_mux_005 (
		.clk                 (clock_out_clk_clk),                            //   input,    width = 1,       clk.clk
		.reset               (mem_bridge_reset_reset_bridge_in_reset_reset), //   input,    width = 1, clk_reset.reset
		.src_ready           (cmd_mux_005_src_ready),                        //   input,    width = 1,       src.ready
		.src_valid           (cmd_mux_005_src_valid),                        //  output,    width = 1,          .valid
		.src_data            (cmd_mux_005_src_data),                         //  output,  width = 349,          .data
		...
		.sink0_data          (cmd_demux_src5_data),                          //   input,  width = 349,          .data
	...
	ethernet_altera_merlin_demultiplexer_181_qa3s35q rsp_demux (
		.clk                (clock_out_clk_clk),                                    //   input,    width = 1,       clk.clk
		.reset              (mem_bridge_reset_reset_bridge_in_reset_reset),         //   input,    width = 1, clk_reset.reset
		.sink_ready         (mac_control_port_rsp_width_adapter_src_ready),         //  output,    width = 1,      sink.ready
		.sink_channel       (mac_control_port_rsp_width_adapter_src_channel),       //   input,    width = 6,          .channel
		.sink_data          (mac_control_port_rsp_width_adapter_src_data),          //   input,  width = 349,          .data
		.sink_startofpacket (mac_control_port_rsp_width_adapter_src_startofpacket), //   input,    width = 1,          .startofpacket
		.sink_endofpacket   (mac_control_port_rsp_width_adapter_src_endofpacket),   //   input,    width = 1,          .endofpacket
		.sink_valid         (mac_control_port_rsp_width_adapter_src_valid),         //   input,    width = 1,          .valid
		.src0_ready         (rsp_demux_src0_ready),                                 //   input,    width = 1,      src0.ready
		.src0_valid         (rsp_demux_src0_valid),                                 //  output,    width = 1,          .valid
		.src0_data          (rsp_demux_src0_data),                                  //  output,  width = 349,          .data
		.src0_channel       (rsp_demux_src0_channel),                               //  output,    width = 6,          .channel
		.src0_startofpacket (rsp_demux_src0_startofpacket),                         //  output,    width = 1,          .startofpacket
		.src0_endofpacket   (rsp_demux_src0_endofpacket)                            //  output,    width = 1,          .endofpacket
	);

	ethernet_altera_merlin_demultiplexer_181_qa3s35q rsp_demux_001 (
		.clk                (clock_out_clk_clk),                              //   input,    width = 1,       clk.clk
		.reset              (mem_bridge_reset_reset_bridge_in_reset_reset),   //   input,    width = 1, clk_reset.reset
		.sink_ready         (dma_rx_csr_rsp_width_adapter_src_ready),         //  output,    width = 1,      sink.ready
		.sink_channel       (dma_rx_csr_rsp_width_adapter_src_channel),       //   input,    width = 6,          .channel
		.sink_data          (dma_rx_csr_rsp_width_adapter_src_data),          //   input,  width = 349,          .data
		.sink_startofpacket (dma_rx_csr_rsp_width_adapter_src_startofpacket), //   input,    width = 1,          .startofpacket
		.sink_endofpacket   (dma_rx_csr_rsp_width_adapter_src_endofpacket),   //   input,    width = 1,          .endofpacket
		.sink_valid         (dma_rx_csr_rsp_width_adapter_src_valid),         //   input,    width = 1,          .valid
		.src0_ready         (rsp_demux_001_src0_ready),                       //   input,    width = 1,      src0.ready
		.src0_valid         (rsp_demux_001_src0_valid),                       //  output,    width = 1,          .valid
		.src0_data          (rsp_demux_001_src0_data),                        //  output,  width = 349,          .data
		.src0_channel       (rsp_demux_001_src0_channel),                     //  output,    width = 6,          .channel
		.src0_startofpacket (rsp_demux_001_src0_startofpacket),               //  output,    width = 1,          .startofpacket
		.src0_endofpacket   (rsp_demux_001_src0_endofpacket)                  //  output,    width = 1,          .endofpacket
	);

	ethernet_altera_merlin_demultiplexer_181_qa3s35q rsp_demux_002 (
		.clk                (clock_out_clk_clk),                              //   input,    width = 1,       clk.clk
		.reset              (mem_bridge_reset_reset_bridge_in_reset_reset),   //   input,    width = 1, clk_reset.reset
		.sink_ready         (dma_tx_csr_rsp_width_adapter_src_ready),         //  output,    width = 1,      sink.ready
		.sink_channel       (dma_tx_csr_rsp_width_adapter_src_channel),       //   input,    width = 6,          .channel
		.sink_data          (dma_tx_csr_rsp_width_adapter_src_data),          //   input,  width = 349,          .data
		.sink_startofpacket (dma_tx_csr_rsp_width_adapter_src_startofpacket), //   input,    width = 1,          .startofpacket
		.sink_endofpacket   (dma_tx_csr_rsp_width_adapter_src_endofpacket),   //   input,    width = 1,          .endofpacket
		.sink_valid         (dma_tx_csr_rsp_width_adapter_src_valid),         //   input,    width = 1,          .valid
		.src0_ready         (rsp_demux_002_src0_ready),                       //   input,    width = 1,      src0.ready
		.src0_valid         (rsp_demux_002_src0_valid),                       //  output,    width = 1,          .valid
		.src0_data          (rsp_demux_002_src0_data),                        //  output,  width = 349,          .data
	...
	ethernet_altera_merlin_demultiplexer_181_qa3s35q rsp_demux_003 (
		...
		.src0_data          (rsp_demux_003_src0_data),                      //  output,  width = 349,          .data
	...
	ethernet_altera_merlin_demultiplexer_181_qa3s35q rsp_demux_004 (
		...
		.src0_data          (rsp_demux_004_src0_data),                      //  output,  width = 349,          .data
	...
	ethernet_altera_merlin_demultiplexer_181_qa3s35q rsp_demux_005 (
		.clk                (clock_out_clk_clk),                                   //   input,    width = 1,       clk.clk
		.reset              (mem_bridge_reset_reset_bridge_in_reset_reset),        //   input,    width = 1, clk_reset.reset
		.sink_ready         (dma_rx_response_rsp_width_adapter_src_ready),         //  output,    width = 1,      sink.ready
		.sink_channel       (dma_rx_response_rsp_width_adapter_src_channel),       //   input,    width = 6,          .channel
		.sink_data          (dma_rx_response_rsp_width_adapter_src_data),          //   input,  width = 349,          .data
		.sink_startofpacket (dma_rx_response_rsp_width_adapter_src_startofpacket), //   input,    width = 1,          .startofpacket
		.sink_endofpacket   (dma_rx_response_rsp_width_adapter_src_endofpacket),   //   input,    width = 1,          .endofpacket
		.sink_valid         (dma_rx_response_rsp_width_adapter_src_valid),         //   input,    width = 1,          .valid
		.src0_ready         (rsp_demux_005_src0_ready),                            //   input,    width = 1,      src0.ready
		.src0_valid         (rsp_demux_005_src0_valid),                            //  output,    width = 1,          .valid
		.src0_data          (rsp_demux_005_src0_data),                             //  output,  width = 349,          .data
	...
	ethernet_altera_merlin_multiplexer_181_tgkewmi rsp_mux (
		.clk                 (clock_out_clk_clk),                            //   input,    width = 1,       clk.clk
		.reset               (mem_bridge_reset_reset_bridge_in_reset_reset), //   input,    width = 1, clk_reset.reset
		.src_ready           (rsp_mux_src_ready),                            //   input,    width = 1,       src.ready
		.src_valid           (rsp_mux_src_valid),                            //  output,    width = 1,          .valid
		.src_data            (rsp_mux_src_data),                             //  output,  width = 349,          .data
		...
		.sink0_data          (rsp_demux_src0_data),                          //   input,  width = 349,          .data
		...
		.sink1_data          (rsp_demux_001_src0_data),                      //   input,  width = 349,          .data
		...
		.sink2_data          (rsp_demux_002_src0_data),                      //   input,  width = 349,          .data
		...
		.sink3_data          (rsp_demux_003_src0_data),                      //   input,  width = 349,          .data
		...
		.sink4_data          (rsp_demux_004_src0_data),                      //   input,  width = 349,          .data
		...
		.sink5_data          (rsp_demux_005_src0_data),                      //   input,  width = 349,          .data
	...
	ethernet_altera_merlin_width_adapter_181_psgyhjq #(
		.IN_PKT_ADDR_H                 (46),
		.IN_PKT_ADDR_L                 (36),
		.IN_PKT_DATA_H                 (31),
		.IN_PKT_DATA_L                 (0),
		...
		.OUT_PKT_RESPONSE_STATUS_H     (336),
		.OUT_PKT_RESPONSE_STATUS_L     (335),
		.OUT_PKT_TRANS_EXCLUSIVE       (304),
		.OUT_PKT_BURST_TYPE_H          (316),
		.OUT_PKT_BURST_TYPE_L          (315),
		.OUT_PKT_ORI_BURST_SIZE_L      (337),
		.OUT_PKT_ORI_BURST_SIZE_H      (339),
		.OUT_ST_DATA_W                 (349),
		.ST_CHANNEL_W                  (6),
		.OPTIMIZE_FOR_RSP              (1),
		.RESPONSE_PATH                 (1),
		...
		.SYNC_RESET                    (0)
	) mac_control_port_rsp_width_adapter (
		.clk                  (clock_out_clk_clk),                                    //   input,    width = 1,       clk.clk
		.reset                (mem_bridge_reset_reset_bridge_in_reset_reset),         //   input,    width = 1, clk_reset.reset
		...
		.in_data              (router_001_src_data),                                  //   input,   width = 97,          .data
		.out_endofpacket      (mac_control_port_rsp_width_adapter_src_endofpacket),   //  output,    width = 1,       src.endofpacket
		.out_data             (mac_control_port_rsp_width_adapter_src_data),          //  output,  width = 349,          .data
		.out_channel          (mac_control_port_rsp_width_adapter_src_channel),       //  output,    width = 6,          .channel
		.out_valid            (mac_control_port_rsp_width_adapter_src_valid),         //  output,    width = 1,          .valid
		.out_ready            (mac_control_port_rsp_width_adapter_src_ready),         //   input,    width = 1,          .ready
		.out_startofpacket    (mac_control_port_rsp_width_adapter_src_startofpacket), //  output,    width = 1,          .startofpacket
	...
	ethernet_altera_merlin_width_adapter_181_psgyhjq #(
		...
		.in_data              (router_002_src_data),                            //   input,   width = 97,          .data
		.out_endofpacket      (dma_rx_csr_rsp_width_adapter_src_endofpacket),   //  output,    width = 1,       src.endofpacket
		.out_data             (dma_rx_csr_rsp_width_adapter_src_data),          //  output,  width = 349,          .data
		.out_channel          (dma_rx_csr_rsp_width_adapter_src_channel),       //  output,    width = 6,          .channel
		.out_valid            (dma_rx_csr_rsp_width_adapter_src_valid),         //  output,    width = 1,          .valid
		.out_ready            (dma_rx_csr_rsp_width_adapter_src_ready),         //   input,    width = 1,          .ready
		.out_startofpacket    (dma_rx_csr_rsp_width_adapter_src_startofpacket), //  output,    width = 1,          .startofpacket
		.in_command_size_data (3'b000)                                          // (terminated),                         
	);
	...
	ethernet_altera_merlin_width_adapter_181_psgyhjq #(
		...
		.in_data              (router_003_src_data),                            //   input,   width = 97,          .data
		.out_endofpacket      (dma_tx_csr_rsp_width_adapter_src_endofpacket),   //  output,    width = 1,       src.endofpacket
		.out_data             (dma_tx_csr_rsp_width_adapter_src_data),          //  output,  width = 349,          .data
		.out_channel          (dma_tx_csr_rsp_width_adapter_src_channel),       //  output,    width = 6,          .channel
		.out_valid            (dma_tx_csr_rsp_width_adapter_src_valid),         //  output,    width = 1,          .valid
		.out_ready            (dma_tx_csr_rsp_width_adapter_src_ready),         //   input,    width = 1,          .ready
		.out_startofpacket    (dma_tx_csr_rsp_width_adapter_src_startofpacket), //  output,    width = 1,          .startofpacket
		.in_command_size_data (3'b000)                                          // (terminated),                         
	);
	...
	ethernet_altera_merlin_width_adapter_181_psgyhjq #(
		...
		.ENABLE_ADDRESS_ALIGNMENT      (0),
		.SYNC_RESET                    (0)
	) dma_rx_response_rsp_width_adapter (
		.clk                  (clock_out_clk_clk),                                   //   input,    width = 1,       clk.clk
		.reset                (mem_bridge_reset_reset_bridge_in_reset_reset),        //   input,    width = 1, clk_reset.reset
		...
		.in_data              (router_006_src_data),                                 //   input,   width = 97,          .data
		.out_endofpacket      (dma_rx_response_rsp_width_adapter_src_endofpacket),   //  output,    width = 1,       src.endofpacket
		.out_data             (dma_rx_response_rsp_width_adapter_src_data),          //  output,  width = 349,          .data
		.out_channel          (dma_rx_response_rsp_width_adapter_src_channel),       //  output,    width = 6,          .channel
		.out_valid            (dma_rx_response_rsp_width_adapter_src_valid),         //  output,    width = 1,          .valid
		.out_ready            (dma_rx_response_rsp_width_adapter_src_ready),         //   input,    width = 1,          .ready
		.out_startofpacket    (dma_rx_response_rsp_width_adapter_src_startofpacket), //  output,    width = 1,          .startofpacket
		.in_command_size_data (3'b000)                                               // (terminated),                         
	);

	ethernet_altera_merlin_width_adapter_181_cifkmai #(
		.IN_PKT_ADDR_H                 (298),
		.IN_PKT_ADDR_L                 (288),
		.IN_PKT_DATA_H                 (255),
		.IN_PKT_DATA_L                 (0),
		...
		.IN_PKT_RESPONSE_STATUS_H      (336),
		.IN_PKT_RESPONSE_STATUS_L      (335),
		.IN_PKT_TRANS_EXCLUSIVE        (304),
		.IN_PKT_BURST_TYPE_H           (316),
		.IN_PKT_BURST_TYPE_L           (315),
		.IN_PKT_ORI_BURST_SIZE_L       (337),
		.IN_PKT_ORI_BURST_SIZE_H       (339),
		.IN_ST_DATA_W                  (349),
		.OUT_PKT_ADDR_H                (46),
		.OUT_PKT_ADDR_L                (36),
		.OUT_PKT_DATA_H                (31),
		...
		.ENABLE_ADDRESS_ALIGNMENT      (0),
		.SYNC_RESET                    (0)
	) mac_control_port_cmd_width_adapter (
		.clk                  (clock_out_clk_clk),                                    //   input,    width = 1,       clk.clk
		.reset                (mem_bridge_reset_reset_bridge_in_reset_reset),         //   input,    width = 1, clk_reset.reset
		...
		.in_data              (cmd_mux_src_data),                                     //   input,  width = 349,          .data
		.out_endofpacket      (mac_control_port_cmd_width_adapter_src_endofpacket),   //  output,    width = 1,       src.endofpacket
		.out_data             (mac_control_port_cmd_width_adapter_src_data),          //  output,   width = 97,          .data
		.out_channel          (mac_control_port_cmd_width_adapter_src_channel),       //  output,    width = 6,          .channel
		.out_valid            (mac_control_port_cmd_width_adapter_src_valid),         //  output,    width = 1,          .valid
		.out_ready            (mac_control_port_cmd_width_adapter_src_ready),         //   input,    width = 1,          .ready
		.out_startofpacket    (mac_control_port_cmd_width_adapter_src_startofpacket), //  output,    width = 1,          .startofpacket
		.in_command_size_data (3'b000)                                                // (terminated),                         
	);
	...
	ethernet_altera_merlin_width_adapter_181_cifkmai #(
		...
		.in_data              (cmd_mux_001_src_data),                           //   input,  width = 349,          .data
		.out_endofpacket      (dma_rx_csr_cmd_width_adapter_src_endofpacket),   //  output,    width = 1,       src.endofpacket
		.out_data             (dma_rx_csr_cmd_width_adapter_src_data),          //  output,   width = 97,          .data
		.out_channel          (dma_rx_csr_cmd_width_adapter_src_channel),       //  output,    width = 6,          .channel
		.out_valid            (dma_rx_csr_cmd_width_adapter_src_valid),         //  output,    width = 1,          .valid
		.out_ready            (dma_rx_csr_cmd_width_adapter_src_ready),         //   input,    width = 1,          .ready
		.out_startofpacket    (dma_rx_csr_cmd_width_adapter_src_startofpacket), //  output,    width = 1,          .startofpacket
		.in_command_size_data (3'b000)                                          // (terminated),                         
	);
	...
	ethernet_altera_merlin_width_adapter_181_cifkmai #(
		...
		.in_data              (cmd_mux_002_src_data),                           //   input,  width = 349,          .data
		.out_endofpacket      (dma_tx_csr_cmd_width_adapter_src_endofpacket),   //  output,    width = 1,       src.endofpacket
		.out_data             (dma_tx_csr_cmd_width_adapter_src_data),          //  output,   width = 97,          .data
		.out_channel          (dma_tx_csr_cmd_width_adapter_src_channel),       //  output,    width = 6,          .channel
		.out_valid            (dma_tx_csr_cmd_width_adapter_src_valid),         //  output,    width = 1,          .valid
		.out_ready            (dma_tx_csr_cmd_width_adapter_src_ready),         //   input,    width = 1,          .ready
		.out_startofpacket    (dma_tx_csr_cmd_width_adapter_src_startofpacket), //  output,    width = 1,          .startofpacket
		.in_command_size_data (3'b000)                                          // (terminated),                         
	);
	...
	ethernet_altera_merlin_width_adapter_181_cifkmai #(
		...
		.ENABLE_ADDRESS_ALIGNMENT      (0),
		.SYNC_RESET                    (0)
	) dma_rx_response_cmd_width_adapter (
		.clk                  (clock_out_clk_clk),                                   //   input,    width = 1,       clk.clk
		.reset                (mem_bridge_reset_reset_bridge_in_reset_reset),        //   input,    width = 1, clk_reset.reset
		...
		.in_data              (cmd_mux_005_src_data),                                //   input,  width = 349,          .data
		.out_endofpacket      (dma_rx_response_cmd_width_adapter_src_endofpacket),   //  output,    width = 1,       src.endofpacket
		.out_data             (dma_rx_response_cmd_width_adapter_src_data),          //  output,   width = 97,          .data
		.out_channel          (dma_rx_response_cmd_width_adapter_src_channel),       //  output,    width = 6,          .channel
		.out_valid            (dma_rx_response_cmd_width_adapter_src_valid),         //  output,    width = 1,          .valid
		.out_ready            (dma_rx_response_cmd_width_adapter_src_ready),         //   input,    width = 1,          .ready
		.out_startofpacket    (dma_rx_response_cmd_width_adapter_src_startofpacket), //  output,    width = 1,          .startofpacket
		.in_command_size_data (3'b000)                                               // (terminated),                         
	);
