...
//   output_name:        ethernet_timing_adapter_181_7qwysyi
//   in_use_ready:       true
//   out_use_ready:      true
//   in_use_valid:       true
//   out_use_valid:      true
...
module ethernet_timing_adapter_181_7qwysyi
(  
 output reg         in_ready,
 input               in_valid,
 ...
 /*AUTOARG*/);
   ...
   //| FIFO
   // ---------------------------------------------------------------------                           
   ethernet_timing_adapter_181_7qwysyi_fifo ethernet_timing_adapter_181_7qwysyi_fifo 
     ( 
       .clk        (clk),
       .reset_n    (reset_n),
       .in_ready   (),
