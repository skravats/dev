// ethernet_altera_avalon_st_adapter_181_bmfedey.v
...
`timescale 1 ps / 1 ps
module ethernet_altera_avalon_st_adapter_181_bmfedey #(
	...
	wire  [255:0] data_format_adapter_0_out_data;          // data_format_adapter_0:out_data -> error_adapter_0:in_data
	...
	wire    [4:0] data_format_adapter_0_out_empty;         // data_format_adapter_0:out_empty -> error_adapter_0:in_empty
	...
	ethernet_data_format_adapter_181_2gqvzui data_format_adapter_0 (
		.clk               (in_clk_0_clk),                            //   input,    width = 1,   clk.clk
		.reset_n           (~in_rst_0_reset),                         //   input,    width = 1, reset.reset_n
		.in_data           (timing_adapter_0_out_data),               //   input,   width = 32,    in.data
		.in_valid          (timing_adapter_0_out_valid),              //   input,    width = 1,      .valid
		.in_ready          (timing_adapter_0_out_ready),              //  output,    width = 1,      .ready
		.in_startofpacket  (timing_adapter_0_out_startofpacket),      //   input,    width = 1,      .startofpacket
		.in_endofpacket    (timing_adapter_0_out_endofpacket),        //   input,    width = 1,      .endofpacket
		.in_empty          (timing_adapter_0_out_empty),              //   input,    width = 2,      .empty
		.in_error          (timing_adapter_0_out_error),              //   input,    width = 6,      .error
		.out_data          (data_format_adapter_0_out_data),          //  output,  width = 256,   out.data
		...
		.out_empty         (data_format_adapter_0_out_empty),         //  output,    width = 5,      .empty
		.out_error         (data_format_adapter_0_out_error)          //  output,    width = 6,      .error
	);

	ethernet_error_adapter_181_jy2tski error_adapter_0 (
		.clk               (in_clk_0_clk),                            //   input,    width = 1,   clk.clk
		.reset_n           (~in_rst_0_reset),                         //   input,    width = 1, reset.reset_n
		.in_data           (data_format_adapter_0_out_data),          //   input,  width = 256,    in.data
		...
		.in_empty          (data_format_adapter_0_out_empty),         //   input,    width = 5,      .empty
		.in_error          (data_format_adapter_0_out_error),         //   input,    width = 6,      .error
		.out_data          (out_0_data),                              //  output,  width = 256,   out.data
		...
		.out_empty         (out_0_empty),                             //  output,    width = 5,      .empty
		.out_error         (out_0_error)                              //  output,    width = 8,      .error
	);

	ethernet_timing_adapter_181_7qwysyi timing_adapter_0 (
		.clk               (in_clk_0_clk),                       //   input,   width = 1,   clk.clk
		.reset_n           (~in_rst_0_reset),                    //   input,   width = 1, reset.reset_n
		...
		.out_data          (timing_adapter_0_out_data),          //  output,  width = 32,   out.data
		.out_valid         (timing_adapter_0_out_valid),         //  output,   width = 1,      .valid
		.out_ready         (timing_adapter_0_out_ready),         //   input,   width = 1,      .ready
		.out_startofpacket (timing_adapter_0_out_startofpacket), //  output,   width = 1,      .startofpacket
		.out_endofpacket   (timing_adapter_0_out_endofpacket),   //  output,   width = 1,      .endofpacket
		.out_empty         (timing_adapter_0_out_empty),         //  output,   width = 2,      .empty
		.out_error         (timing_adapter_0_out_error)          //  output,   width = 6,      .error
	);
