// mcu_system_mm_interconnect_0.v
...
`timescale 1 ps / 1 ps
module mcu_system_mm_interconnect_0 (
	...
	wire  [16:0] i2c_csr_agent_m0_address;                                                  // i2c_csr_agent:m0_address -> i2c_csr_translator:uav_address
	...
	wire  [91:0] i2c_csr_agent_rf_source_data;                                              // i2c_csr_agent:rf_source_data -> i2c_csr_agent_rsp_fifo:in_data
	...
	wire  [91:0] i2c_csr_agent_rsp_fifo_out_data;                                           // i2c_csr_agent_rsp_fifo:out_data -> i2c_csr_agent:rf_sink_data
	...
	wire         cmd_mux_001_src_valid;                                                     // cmd_mux_001:src_valid -> i2c_csr_agent:cp_valid
	wire  [90:0] cmd_mux_001_src_data;                                                      // cmd_mux_001:src_data -> i2c_csr_agent:cp_data
	wire         cmd_mux_001_src_ready;                                                     // i2c_csr_agent:cp_ready -> cmd_mux_001:src_ready
	wire   [3:0] cmd_mux_001_src_channel;                                                   // cmd_mux_001:src_channel -> i2c_csr_agent:cp_channel
	wire         cmd_mux_001_src_startofpacket;                                             // cmd_mux_001:src_startofpacket -> i2c_csr_agent:cp_startofpacket
	wire         cmd_mux_001_src_endofpacket;                                               // cmd_mux_001:src_endofpacket -> i2c_csr_agent:cp_endofpacket
	...
	wire  [90:0] cmd_mux_002_src_data;                                                      // cmd_mux_002:src_data -> cpu_debug_mem_slave_agent:cp_data
	...
	wire         i2c_csr_agent_rp_valid;                                                    // i2c_csr_agent:rp_valid -> router_003:sink_valid
	wire  [90:0] i2c_csr_agent_rp_data;                                                     // i2c_csr_agent:rp_data -> router_003:sink_data
	wire         i2c_csr_agent_rp_ready;                                                    // router_003:sink_ready -> i2c_csr_agent:rp_ready
	wire         i2c_csr_agent_rp_startofpacket;                                            // i2c_csr_agent:rp_startofpacket -> router_003:sink_startofpacket
	wire         i2c_csr_agent_rp_endofpacket;                                              // i2c_csr_agent:rp_endofpacket -> router_003:sink_endofpacket
	...
	wire  [90:0] cpu_debug_mem_slave_agent_rp_data;                                         // cpu_debug_mem_slave_agent:rp_data -> router_004:sink_data
	...
	wire         i2c_csr_agent_rdata_fifo_src_valid;                                        // i2c_csr_agent:rdata_fifo_src_valid -> avalon_st_adapter_001:in_0_valid
	wire  [33:0] i2c_csr_agent_rdata_fifo_src_data;                                         // i2c_csr_agent:rdata_fifo_src_data -> avalon_st_adapter_001:in_0_data
	wire         i2c_csr_agent_rdata_fifo_src_ready;                                        // avalon_st_adapter_001:in_0_ready -> i2c_csr_agent:rdata_fifo_src_ready
	wire         avalon_st_adapter_001_out_0_valid;                                         // avalon_st_adapter_001:out_0_valid -> i2c_csr_agent:rdata_fifo_sink_valid
	wire  [33:0] avalon_st_adapter_001_out_0_data;                                          // avalon_st_adapter_001:out_0_data -> i2c_csr_agent:rdata_fifo_sink_data
	wire         avalon_st_adapter_001_out_0_ready;                                         // i2c_csr_agent:rdata_fifo_sink_ready -> avalon_st_adapter_001:out_0_ready
	wire   [0:0] avalon_st_adapter_001_out_0_error;                                         // avalon_st_adapter_001:out_0_error -> i2c_csr_agent:rdata_fifo_sink_error
	...
	mcu_system_mm_interconnect_0_router router (
	...
	mcu_system_mm_interconnect_0_router_001 router_001 (
	...
	mcu_system_mm_interconnect_0_router_003 router_003 (
	...
	mcu_system_mm_interconnect_0_router_002 router_004 (
	...
	mcu_system_mm_interconnect_0_router_002 router_005 (
	...
	mcu_system_mm_interconnect_0_cmd_demux cmd_demux (
		.clk                (clk_0_clk_clk),                         //       clk.clk
		.reset              (cpu_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	mcu_system_mm_interconnect_0_cmd_demux_001 cmd_demux_001 (
		.clk                (clk_0_clk_clk),                         //       clk.clk
		.reset              (cpu_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	mcu_system_mm_interconnect_0_cmd_mux cmd_mux (
		.clk                 (clk_0_clk_clk),                         //       clk.clk
		.reset               (cpu_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	mcu_system_mm_interconnect_0_cmd_mux_001 cmd_mux_001 (
		.clk                 (clk_0_clk_clk),                         //       clk.clk
		.reset               (cpu_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	mcu_system_mm_interconnect_0_cmd_mux cmd_mux_002 (
		.clk                 (clk_0_clk_clk),                         //       clk.clk
		.reset               (cpu_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	mcu_system_mm_interconnect_0_cmd_mux cmd_mux_003 (
		.clk                 (clk_0_clk_clk),                         //       clk.clk
		.reset               (cpu_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	mcu_system_mm_interconnect_0_rsp_demux rsp_demux (
		.clk                (clk_0_clk_clk),                         //       clk.clk
		.reset              (cpu_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	mcu_system_mm_interconnect_0_rsp_demux_001 rsp_demux_001 (
		.clk                (clk_0_clk_clk),                         //       clk.clk
		.reset              (cpu_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	mcu_system_mm_interconnect_0_rsp_demux rsp_demux_002 (
		.clk                (clk_0_clk_clk),                         //       clk.clk
		.reset              (cpu_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	mcu_system_mm_interconnect_0_rsp_demux rsp_demux_003 (
		.clk                (clk_0_clk_clk),                         //       clk.clk
		.reset              (cpu_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	mcu_system_mm_interconnect_0_rsp_mux rsp_mux (
		.clk                 (clk_0_clk_clk),                         //       clk.clk
		.reset               (cpu_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	mcu_system_mm_interconnect_0_rsp_mux_001 rsp_mux_001 (
		.clk                 (clk_0_clk_clk),                         //       clk.clk
		.reset               (cpu_reset_reset_bridge_in_reset_reset), // clk_reset.reset
